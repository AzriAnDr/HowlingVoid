...
| Гайд по зеркалированию       | [./documentations/core_migration/legacy_modular_docs/mirroring_guide.md](./documentations/core_migration/legacy_modular_docs/mirroring_guide.md)                                                                 |
...
Howling Void - билд на базе Nova Sector /tg/station, созданное в byond.
...
Скажите администрации что готовы заняться этой механикой.

Вы не можете реализовать?

Идёте сюда -> https://discord.com/channels/1399667370267508748/1420156150850130063
