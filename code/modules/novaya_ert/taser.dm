/obj/item/gun/energy/taser/crank
	...
	icon = 'icons/novaya_ert/taser.dmi'
	icon_state = "crank_taser"
	lefthand_file = 'icons/novaya_ert/taser_left.dmi'
	righthand_file = 'icons/novaya_ert/taser_right.dmi'
...
/obj/item/gun/energy/taser/crank/Initialize(mapload)
	...
	AddComponent( \
		...
		charge_sound = 'sound/new_cells/crank.ogg', \
