/obj/item/melee/baton/security/stun_gun
	...
	icon = 'icons/novaya_ert/stun_gun.dmi'
	icon_state = "stun_gun"
	lefthand_file = 'icons/novaya_ert/stun_gun_left.dmi'
	righthand_file = 'icons/novaya_ert/stun_gun_right.dmi'
...
/obj/item/melee/baton/security/stun_gun/stun_knife
	...
	icon = 'icons/novaya_ert/stun_knife.dmi'
	icon_state = "stun_knife"
	lefthand_file = 'icons/novaya_ert/stun_knife_left.dmi'
	righthand_file = 'icons/novaya_ert/stun_knife_right.dmi'
