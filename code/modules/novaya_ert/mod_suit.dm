/datum/mod_theme/rim_inspector
	...
	variants = list(
		"rim_inspector" = list(
			MOD_ICON_OVERRIDE = 'icons/novaya_ert/mod.dmi',
			MOD_WORN_ICON_OVERRIDE = 'icons/novaya_ert/wornmod.dmi',
...
/obj/item/mod/module/status_readout/operational
	...
	display_time = TRUE
	death_sound = 'sound/novaya_ert/flatline.ogg'
...
/obj/item/crafting_conversion_kit/voskhod_refit
	...
	force = 10
	icon = 'icons/novaya_ert/refit_kit.dmi'
