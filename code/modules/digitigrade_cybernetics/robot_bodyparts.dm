...
/obj/item/bodypart/leg/right/robot/digi
	...
	icon_static = 'icons/digitigrade_cybernetics/digitigrade_parts.dmi'
	icon = 'icons/digitigrade_cybernetics/digitigrade_parts.dmi'
...
/obj/item/bodypart/leg/right/robot/advanced/digi
	...
	icon_static = 'icons/digitigrade_cybernetics/advanced_digitigrade_parts.dmi'
	icon = 'icons/digitigrade_cybernetics/advanced_digitigrade_parts.dmi'
	bodyshape = parent_type::bodyshape | BODYSHAPE_DIGITIGRADE
	is_emissive = FALSE
