...
/// Handles adding the gun safety component to guns that support safeties.
...
/// Adds manufacturer examine information to the gun. Subtypes opt in with their company string.
...
/obj/item/gun/ballistic/automatic/c20r/give_manufacturer_examine()
	AddElement(/datum/element/manufacturer_examine, COMPANY_SCARBOROUGH)
...
// BEGIN NOVA CORE MIGRATION: code/modules/projectiles/gun.dm
...
/obj/item/gun/proc/get_lore_blurb()
	return lore_blurb
// END NOVA CORE MIGRATION: code/modules/projectiles/gun.dm
