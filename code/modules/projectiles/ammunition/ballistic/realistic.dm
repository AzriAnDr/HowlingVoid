...
/obj/item/ammo_casing/realistic
	icon = 'icons/obj/weapons/guns/surplus/ammo.dmi'
...
/obj/item/ammo_casing/realistic/a762x39/fire
	...
	custom_materials = list(/datum/material/iron = SMALL_MATERIAL_AMOUNT * 1.6, /datum/material/plasma = SMALL_MATERIAL_AMOUNT * 0.4)
...
/obj/item/ammo_casing/realistic/a762x39/ap
	...
	custom_materials = list(/datum/material/iron = SMALL_MATERIAL_AMOUNT * 1.6, /datum/material/titanium = SMALL_MATERIAL_AMOUNT * 0.4)
...
/obj/item/ammo_casing/realistic/a762x39/emp
	...
	custom_materials = list(/datum/material/iron = SMALL_MATERIAL_AMOUNT * 1.6, /datum/material/uranium = SMALL_MATERIAL_AMOUNT * 0.4)
