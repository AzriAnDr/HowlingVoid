/obj/item/gun/ballistic/shotgun/katyusha
	...
	icon = 'icons/obj/weapons/guns/nanotrasen_armories/ballistic48x.dmi'
	icon_state = "spikewall"

	worn_icon = 'icons/mob/clothing/back/guns/nanotrasen_armories/guns_worn.dmi'
	worn_icon_state = "spikewall"

	lefthand_file = 'icons/mob/inhands/weapons/guns/nanotrasen_armories/guns_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns/nanotrasen_armories/guns_righthand.dmi'
