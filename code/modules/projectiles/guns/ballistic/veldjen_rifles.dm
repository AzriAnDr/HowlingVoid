...
/obj/item/gun/ballistic/automatic/sol_classic
	...
	icon = 'icons/obj/weapons/guns/veldjen_kuiper/guns48x.dmi'
	icon_state = "infanterie"

	worn_icon = 'icons/mob/clothing/back/guns/veldjen_kuiper/guns_worn.dmi'
	worn_icon_state = "infanterie"

	lefthand_file = 'icons/mob/inhands/weapons/guns/veldjen_kuiper/guns_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns/veldjen_kuiper/guns_righthand.dmi'
