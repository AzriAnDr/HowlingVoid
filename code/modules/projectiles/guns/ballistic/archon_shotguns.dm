...
/obj/item/gun/ballistic/shotgun/riot/sol/super
	...
	icon = 'icons/obj/weapons/guns/archon_combat_systems/guns48x.dmi'
	icon_state = "renoster_super"

	worn_icon = 'icons/mob/clothing/back/guns/carwo_defense_systems/guns_worn.dmi'
	worn_icon_state = "renoster"

	lefthand_file = 'icons/mob/inhands/weapons/guns/archon_combat_systems/guns_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns/archon_combat_systems/guns_righthand.dmi'
...
/datum/action/item_action/booster/sol_super
	button_icon = 'icons/obj/weapons/kits/archon_combat_systems/parts_kits.dmi'
...
/obj/item/gun/ballistic/shotgun/doublebarrel/super
	...
	worn_icon = 'icons/mob/clothing/back/guns/archon_combat_systems/guns_worn.dmi'
	worn_icon_state = "double_super"

	lefthand_file = 'icons/mob/inhands/weapons/guns/archon_combat_systems/64x_guns_left.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns/archon_combat_systems/64x_guns_right.dmi'
