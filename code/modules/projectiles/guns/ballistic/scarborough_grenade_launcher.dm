...
/obj/item/gun/ballistic/pump_launcher
	...
	icon = 'icons/obj/weapons/guns/scarborough_arms/launchers48x.dmi'
	icon_state = "boarder40"
	worn_icon = 'icons/mob/clothing/back/guns/scarborough_arms/guns_worn.dmi'
	worn_icon_state = "boarder"
	lefthand_file = 'icons/mob/inhands/weapons/guns/scarborough_arms/guns_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns/scarborough_arms/guns_righthand.dmi'
