...
/obj/item/gun/ballistic/automatic/sol_grenade_launcher
	...
	icon = 'icons/obj/weapons/guns/carwo_defense_systems/guns48x.dmi'
	icon_state = "kiboko"

	worn_icon = 'icons/mob/clothing/back/guns/carwo_defense_systems/guns_worn.dmi'
	worn_icon_state = "kiboko"

	lefthand_file = 'icons/mob/inhands/weapons/guns/carwo_defense_systems/guns_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns/carwo_defense_systems/guns_righthand.dmi'
