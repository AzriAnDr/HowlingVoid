/obj/item/gun/ballistic/automatic/smart_machine_gun
	...
	icon = 'icons/marines/items/guns.dmi'
	lefthand_file = 'icons/marines/mobs/guns_l.dmi'
	righthand_file = 'icons/marines/mobs/guns_r.dmi'
	worn_icon = 'icons/marines/mobs/mod_modules.dmi'
	icon_state = "smartgun"
...
/obj/item/ammo_box/magazine/smartgun_drum
	...
	icon = 'icons/marines/items/ammo.dmi'
