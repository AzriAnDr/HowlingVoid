...
/obj/item/clothing/suit/armor/forging_plate_armor
	...
	icon = 'icons/reagent_forging/obj/forge_clothing.dmi'
	worn_icon = 'icons/reagent_forging/mob/clothing/forge_clothing.dmi'
	worn_icon_better_vox = 'icons/reagent_forging/mob/clothing/forge_clothing_newvox.dmi'
	worn_icon_vox = 'icons/reagent_forging/mob/clothing/forge_clothing_oldvox.dmi'
	worn_icon_teshari = 'icons/reagent_forging/mob/clothing/forge_clothing_teshari.dmi'
...
/obj/item/clothing/suit/armor/forging_chain_shirt
	...
	icon = 'icons/primitive_catgirls/objects.dmi'
	worn_icon = 'icons/primitive_catgirls/clothing_greyscale.dmi'
	supports_variations_flags = CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON
	resistance_flags = FIRE_PROOF
	obj_flags_nova = ANVIL_REPAIR
	body_parts_covered = GROIN|CHEST
...
/obj/item/clothing/shoes/forging_plate_boots
	...
	icon = 'icons/reagent_forging/obj/forge_clothing.dmi'
	worn_icon = 'icons/reagent_forging/mob/clothing/forge_clothing.dmi'
	worn_icon_digi = 'icons/reagent_forging/mob/clothing/forge_clothing_digi.dmi'
	worn_icon_better_vox = 'icons/reagent_forging/mob/clothing/forge_clothing_newvox.dmi'
	worn_icon_vox = 'icons/reagent_forging/mob/clothing/forge_clothing_oldvox.dmi'
	worn_icon_teshari = 'icons/reagent_forging/mob/clothing/forge_clothing_teshari.dmi'
...
/obj/item/clothing/neck/collar/reagent_clothing
	...
	icon = 'icons/modular_items/lewd_items/icons/obj/lewd_clothing/lewd_neck.dmi'
	worn_icon = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_neck.dmi'
