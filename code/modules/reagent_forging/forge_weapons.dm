...
/obj/item/forging/reagent_weapon
	icon = 'icons/reagent_forging/obj/forge_items.dmi'
	lefthand_file = 'icons/reagent_forging/mob/forge_weapon_l.dmi'
	righthand_file = 'icons/reagent_forging/mob/forge_weapon_r.dmi'
	worn_icon = 'icons/reagent_forging/mob/forge_weapon_worn.dmi'
