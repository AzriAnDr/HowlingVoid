/obj/structure/mineral_door/manual_colony_door
	name = "manual airlock"
	icon = 'icons/colony_fabricator/doors/airlock_manual.dmi'
	material_flags = NONE
	icon_state = "manual"
	openSound = 'sound/colony_fabricator/manual_door/manual_door_open.wav'
	closeSound = 'sound/colony_fabricator/manual_door/manual_door_close.wav'
...
/obj/item/flatpacked_machine/airlock_kit_manual
	...
	icon = 'icons/colony_fabricator/doors/packed.dmi'
