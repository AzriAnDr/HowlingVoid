/obj/item/melee/tomahawk
	...
	icon = 'icons/exp_corps/tomahawk.dmi'
	icon_state = "tomahawk"
	inhand_icon_state = "tomahawk"
	lefthand_file = 'icons/exp_corps/tomahawk_l.dmi'
	righthand_file = 'icons/exp_corps/tomahawk_r.dmi'
	worn_icon = 'icons/exp_corps/tomahawk_worn.dmi'
