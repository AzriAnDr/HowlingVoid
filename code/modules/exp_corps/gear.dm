...
/obj/item/circular_saw/field_medic
	...
	force = 20
	icon_state = "bonesaw"
	icon = 'icons/exp_corps/bonesaw.dmi'
	lefthand_file = 'icons/exp_corps/bonesaw_l.dmi'
	righthand_file = 'icons/exp_corps/bonesaw_r.dmi'
...
/obj/item/shield/riot/pointman
	...
	icon_state = "riot"
	icon = 'icons/exp_corps/riot.dmi'
	worn_icon = 'icons/mob/clothing/back_additions.dmi'
	worn_icon_state = "erisriot"
	lefthand_file = 'icons/exp_corps/riot_left.dmi'
	righthand_file = 'icons/exp_corps/riot_right.dmi'
	force = 10
	throwforce = 5
	throw_speed = 1
	throw_range = 1
...
/obj/item/knife/combat/throwing
	...
	icon = 'icons/exp_corps/throwing.dmi'
	icon_state = "throwing"
