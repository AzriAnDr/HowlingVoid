/obj/item/scythe
	...
	icon = 'icons/space_vines/items_and_weapons.dmi'
	icon_state = "scythe_t1"
	worn_icon = 'icons/space_vines/back.dmi'
	lefthand_file = 'icons/space_vines/polearms_lefthand.dmi'
	righthand_file = 'icons/space_vines/polearms_righthand.dmi'
	force = 13
	throwforce = 5
	throw_speed = 2
	throw_range = 3
