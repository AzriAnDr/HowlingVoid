...
/obj/item/clothing/under/sol_peacekeeper
	...
	icon = 'icons/goofsec/obj/uniforms.dmi'
	icon_state = "peacekeeper"
	worn_icon = 'icons/goofsec/mob/uniforms.dmi'
	worn_icon_digi = 'icons/goofsec/mob/uniforms_digi.dmi'
...
/obj/item/clothing/neck/mantle/solfed
	...
	icon = 'icons/goofsec/obj/neck.dmi'
	icon_state = "recovermantle"
	worn_icon = 'icons/goofsec/mob/neck.dmi'
