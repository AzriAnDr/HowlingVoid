...
/datum/antagonist/ashwalker/on_gain()
	...
	//owner.current.remove_faction(FACTION_NEUTRAL) // ashwalkers aren't neutral; they're ashwalker-aligned // NOVA EDIT REMOVAL - Keeping Neutral and moving the rest to a ritual
...
/datum/antagonist/ashwalker/on_removal()
	...
	//owner.current.add_faction(FACTION_NEUTRAL) // NOVA EDIT REMOVAL - Keeping Neutral and moving the rest to a ritual
