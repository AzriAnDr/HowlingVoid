...
// BEGIN NOVA CORE MIGRATION: code/modules/antagonists/heretic/magic/space_crawl.dm
/datum/action/cooldown/spell/jaunt/space_crawl
...
// END NOVA CORE MIGRATION: code/modules/antagonists/heretic/magic/space_crawl.dm
