...
/obj/item/melee/implantarmblade
	...
	icon = 'icons/implants/implanted_blade.dmi'
	righthand_file = 'icons/implants/implanted_blade_righthand.dmi'
	lefthand_file = 'icons/implants/implanted_blade_lefthand.dmi'
...
/obj/item/knife/razor_claws
	...
	icon = 'icons/implants/razorclaws.dmi'
	righthand_file = 'icons/implants/razorclaws_righthand.dmi'
	lefthand_file = 'icons/implants/razorclaws_lefthand.dmi'
...
/datum/action/item_action/organ_action/toggle/razor_claws
	...
	button_icon = 'icons/hud/actions_additions.dmi'
...
/obj/item/organ/cyberimp/arm/toolkit/mining_drill
	...
	icon = 'icons/implants/drillimplant.dmi'
	icon_state = "steel"
	items_to_create = list(/obj/item/pickaxe/drill/implant)
	aug_icon = 'icons/implants/implants_onmob.dmi'
	aug_overlay = "steel"
	hand_state = FALSE
...
/obj/item/pickaxe/drill/implant
	...
	slot_flags = NONE
	icon = 'icons/implants/drillimplant.dmi'
	righthand_file = 'icons/implants/drillimplant_righthand.dmi'
	lefthand_file = 'icons/implants/drillimplant_lefthand.dmi'
	icon_state = "steel"
...
/obj/item/pickaxe/drill/implant/verb/spin()
	...
	playsound(user, 'sound/effects/robot_smoke.ogg', 50, FALSE)
...
/obj/item/melee/razorwire
	...
	icon = 'icons/implants/implants.dmi'
	icon_state = "razorwire_weapon"
	righthand_file = 'icons/implants/inhands/righthand.dmi'
	lefthand_file = 'icons/implants/inhands/lefthand.dmi'
