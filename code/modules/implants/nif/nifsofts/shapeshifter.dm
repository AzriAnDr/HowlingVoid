...
/datum/action/innate/alter_form/nif
	...
	background_icon = 'icons/mob/actions/action_backgrounds.dmi'
...
/datum/action/innate/alter_form/nif/change_form(mob/living/carbon/human/alterer)
	var/selected_alteration = show_radial_menu(
		...
		alterer,
		list(
			"DNA" = image(icon = 'icons/mob/actions/actions_slime_additions.dmi', icon_state = "dna"),
			"Hair" = image(icon = 'icons/mob/actions/actions_slime_additions.dmi', icon_state = "scissors"),
			"Markings" = image(icon = 'icons/mob/actions/actions_slime_additions.dmi', icon_state = "rainbow_spraycan"),
		),
		tooltips = TRUE,
	)
