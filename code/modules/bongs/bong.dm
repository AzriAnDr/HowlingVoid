/obj/item/bong
	...
	icon = 'icons/bongs/bong.dmi'
	lefthand_file = 'icons/bongs/lefthand.dmi'
	righthand_file = 'icons/bongs/righthand.dmi'
	icon_state = "bongoff"
...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('sound/effects/lungbust_moan1.ogg','sound/effects/lungbust_moan2.ogg', 'sound/effects/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('sound/effects/lungbust_cough1.ogg','sound/effects/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
