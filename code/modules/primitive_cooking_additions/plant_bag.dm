...
/datum/atom_skin/plant_bag/linen
	preview_name = "Linen"
	new_icon = 'icons/primitive_cooking_additions/plant_bag.dmi'
	new_icon_state = "plantbag_primitive"
	new_worn_icon = 'icons/primitive_cooking_additions/plant_bag_worn.dmi'
...
/obj/item/storage/bag/plants/primitive
	icon = 'icons/primitive_cooking_additions/plant_bag.dmi'
	icon_state = "plantbag_primitive"
	worn_icon = 'icons/primitive_cooking_additions/plant_bag_worn.dmi'
