/mob/living/basic/pet/cat/fennec
	...
	held_lh = 'icons/mob/inhands/pets_held_lh_additions.dmi'
	held_rh = 'icons/mob/inhands/pets_held_rh_additions.dmi'
	head_icon = 'icons/mob/clothing/head/pets_head_additions.dmi'
