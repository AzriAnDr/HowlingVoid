...
/datum/atom_skin/snail_backpack
	abstract_type = /datum/atom_skin/snail_backpack
	new_icon = 'icons/obj/clothing/backpacks.dmi'
	new_worn_icon = 'icons/mob/clothing/back_additions.dmi'

/datum/atom_skin/snail_backpack/coneshell
