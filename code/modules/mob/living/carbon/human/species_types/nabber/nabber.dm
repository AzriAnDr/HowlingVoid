...
/datum/species/nabber
	...
	inherent_traits = list(
		...
		TRAIT_PUSHIMMUNE,
		TRAIT_LIGHT_STEP, // Balance and species logic.
...
// Shows voice implant damage to other players.
...
// Nabbers cannot be handcuffed while scythes are active.
...
// Aggressive grabs do not slow nabbers while scythes are active.
...
/mob/living/carbon/human/add_quirk(datum/quirk/quirktype, client/override_client, add_unique = TRUE, announce = TRUE)
	var/static/bad_nabber_quirks = list(
		...
		/datum/quirk/item_quirk/allergic, // Before breathing system support.
		/datum/quirk/badback,
		...
		/datum/quirk/personalspace, // Built in.
		...
		/datum/quirk/light_step, // Built in.
