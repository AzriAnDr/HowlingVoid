#define NABBER_PUNCH_LOW 3 // Humanoid manipulator arms are weak.
#define NABBER_PUNCH_HIGH 5
#define BODYPART_ICON_NABBER 'icons/mob/species/nabber/nabber_parts_greyscale.dmi'
#define NABBER_BRUTE_MODIFIER 0.7 // Nabbers are heavily armored.
...
/obj/item/bodypart/head/mutant/nabber
	...
	eyes_icon = 'icons/mob/species/nabber/nabber_eyes.dmi'
