...
/atom/proc/prepare_huds()
	...
	for(var/hud in hud_possible)
		...
		if(hint == HUD_LIST_LIST)
			...
			var/image/I = image(GLOB.merged_huds, src, "")
...
/**
 * Sends this mob to cryogenic storage.
 */
/mob/proc/vv_send_cryo()
	...
	send_to_cryo(send_notice == "Yes")

/**
 * Overrides this mob with its loaded client preferences.
 */
