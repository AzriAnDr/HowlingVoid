...
// BEGIN NOVA CORE MIGRATION: code/modules/modular_computers/computers/machinery/modular_computer.dm
//////
//
...
/obj/item/modular_computer/ui_interact(mob/user, datum/tgui/ui)
	if(HAS_TRAIT_FROM(user, TRAIT_FREE_GHOST, TRAIT_GHOSTROLE))
		...
		return
	return ..()
// END NOVA CORE MIGRATION: code/modules/modular_computers/computers/machinery/modular_computer.dm
