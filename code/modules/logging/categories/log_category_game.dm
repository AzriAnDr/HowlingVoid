...
// BEGIN NOVA CORE MIGRATION: code/modules/logging/categories/log_category_game.dm
...
/datum/log_category/game_subtler
	...
	master_category = /datum/log_category/game
// END NOVA CORE MIGRATION: code/modules/logging/categories/log_category_game.dm
