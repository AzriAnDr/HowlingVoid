...
/obj/item/storage/pouch
	...
	icon = 'icons/obj/items/nova/storage.dmi'
	icon_state = "survival"
...
/datum/storage/pouch/medical/small
	...
	here's a thought: the pocket first aid kit from the colonial replicator [code\modules\food_replicator\storage.dm] has
