...
// BEGIN NOVA CORE MIGRATION: code/modules/shuttle/shuttle.dm
/obj/docking_port/mobile
	/// Does this shuttle play sounds upon landing and takeoff?
	var/shuttle_sounds = TRUE
	/// The take off sound to be played
	var/takeoff_sound = sound('sound/advanced_shuttles/engine_startup.ogg')
	/// The landing sound to be played
	var/landing_sound = sound('sound/advanced_shuttles/engine_landing.ogg')
...
// END NOVA CORE MIGRATION: code/modules/shuttle/shuttle.dm
