...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'icons/hyposprays/hyposprays.dmi'
	...
	var/original_icon = 'icons/hyposprays/hyposprays.dmi'
...
/obj/item/hypospray/mkii/proc/do_inject(mob/living/injectee, mob/living/user, mode)
	...
	playsound(loc, long_sound ? 'sound/hyposprays/hypospray_long.ogg' : pick('sound/hyposprays/hypospray.ogg','sound/hyposprays/hypospray2.ogg'), 50, 1, -1)
