/obj/item/machete
	...
	icon = 'icons/mauling_melees/objects.dmi'
	icon_state = "machete"
	lefthand_file = 'icons/mauling_melees/lefthands.dmi'
	righthand_file = 'icons/mauling_melees/righthands.dmi'
...
/obj/item/storage/belt/machete
	...
	icon = 'icons/mauling_melees/objects.dmi'
	worn_icon = 'icons/mauling_melees/back.dmi'
	lefthand_file = 'icons/mauling_melees/lefthands.dmi'
	righthand_file = 'icons/mauling_melees/righthands.dmi'
	icon_state = "msheath"
...
/datum/storage/machete_belt
	...
	rustle_sound = 'sound/mauling_melees/rifle_draw.ogg'
	remove_rustle_sound = 'sound/mauling_melees/rifle_draw.ogg'
