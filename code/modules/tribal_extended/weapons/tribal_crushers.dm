...
/obj/item/kinetic_crusher/runic_greatsword
	...
	icon = 'icons/tribal_extended/tribal_crushers.dmi'
...
/obj/item/kinetic_crusher/runic_greataxe
	...
	icon = 'icons/tribal_extended/tribal_crushers.dmi' //Modified sprite from Roguetown
...
/obj/item/kinetic_crusher/spear/runic_spear
	...
	icon = 'icons/tribal_extended/tribal_crushers.dmi' //Custom sprite, i'm a bad spriter, mhkay?
...
/obj/item/kinetic_crusher/proc/add_runic_glow()
	return emissive_appearance(
		'icons/tribal_extended/tribal_crushers.dmi',
		"[icon_state]-emissive",
		src,
		alpha = src.alpha
	)
...
/datum/asset/spritesheet_batched/crafting/create_spritesheets()
	. = ..()
	insert_icon(replacetext(TOOL_HAMMER, " ", ""), uni_icon('icons/reagent_forging/obj/forge_items.dmi', "hammer"))
