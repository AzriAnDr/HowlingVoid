...
/datum/glass_style/drinking_glass/starfruit_soda
	...
	icon = 'icons/obj/food/starfruit.dmi'
	icon_state = "starsoda"
...
/obj/item/book/manual/starfruit
	...
	icon = 'icons/obj/starfruitbook.dmi'
	icon_state = "cookbook"
	lefthand_file = 'icons/mob/inhands/starfruitbook_lhand.dmi'
	righthand_file = 'icons/mob/inhands/starfruitbook_rhand.dmi'
