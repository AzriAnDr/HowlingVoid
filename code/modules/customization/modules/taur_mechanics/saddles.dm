/obj/item/riding_saddle
	...
	icon = 'icons/customization/modules/taur_mechanics/icons/saddles.dmi'
	worn_icon = 'icons/customization/modules/taur_mechanics/icons/saddles.dmi'
	worn_icon_taur_snake = 'icons/customization/modules/taur_mechanics/icons/saddles.dmi'
