...
/datum/robotic_style/scrappyipc
	name = "Scrappy"
	icon = 'icons/mob/augmentation/scrappyipc.dmi' // for ones that don't have associated limb atoms just setting icon works fine
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/scrappyipc_greyscale
	name = "Scrappy (Greyscale)"
	icon = 'icons/mob/augmentation/scrappyipc_greyscale.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE
...
/datum/robotic_style/zhenkovipc_dark
	...
	icon = 'icons/mob/augmentation/zhenkovipc_dark.dmi'
	supported_slots = LEGS
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE
