// Modular Booze REAGENTS, see the following file for the mixes: code\modules\customization\food_and_drinks\recipes\drinks_recipes.dm
...
/datum/glass_style/drinking_glass/synthanol
	...
	icon = 'icons/obj/drinks.dmi' // This should cover anything synthanol related. Will have to individually tag others unless we make an object path for Nova drinks.
