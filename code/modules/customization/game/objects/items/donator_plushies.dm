...
/obj/item/toy/plush/nova/donator/plushie_star
	...
	gender = FEMALE
	squeak_override = list('sound/emotes/voice/trills.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/plushie_jeanne
	...
	squeak_override = list('sound/customization/game/objects/items/sound/deerplush.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/plushie_elofy
	...
	squeak_override = list('sound/customization/game/objects/items/sound/merowr.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/snow_owl
	...
	squeak_override = list('sound/emotes/voice/hoot.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/derg_plushie
	...
	squeak_override = list('sound/emotes/voice/weh.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/tracy
	...
	squeak_override = list('sound/customization/game/objects/items/sound/tracymrowr.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/plushie_synthia
	...
	squeak_override = list('sound/emotes/emotes/twobeep.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/jecca
	...
	squeak_override = list('sound/emotes/emotes/female/female_sigh.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/plush_hemlock
	...
	squeak_override = list('sound/emotes/voice/arf.ogg'= 1)
...
/obj/item/toy/plush/nova/donator/blue_cat
	...
	squeak_override = list('sound/emotes/voice/nya.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/leaplush
	...
	squeak_override = list('sound/customization/game/objects/items/sound/leaplush.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/sharknet
	...
	squeak_override = list('sound/emotes/voice/slime_squish.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/nova/donator/szaplush
	...
	squeak_override = list('sound/customization/game/objects/items/sound/spiderplush.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/nova/donator/tribal_salamander
	...
	squeak_override = list('sound/emotes/voice/wurble.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/commanding_teshari
	...
	squeak_override = list('sound/emotes/voice/peep_once.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/skreking_vox
	...
	squeak_override = list('sound/emotes/emotes/voxrustle.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/edgy_bird
	...
	squeak_override = list('sound/emotes/voice/caw.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/xixi
	...
	attack_verb_simple = list(
		...
		"peck",)
	squeak_override = list(
		'sound/emotes/voice/peep_once.ogg' = 1,
		'sound/emotes/voice/caw.ogg' = 1,
		'sound/emotes/voice/bawk.ogg' = 1,
		'sound/emotes/emotes/voxscream.ogg' = 1,
		)
...
/obj/item/toy/plush/nova/donator/roselia
	...
	attack_verb_continuous = list("hugs")
	attack_verb_simple = list("hug")
	squeak_override = list('sound/emotes/voice/merp.ogg' = 1)
	young = FALSE
...
/obj/item/toy/plush/nova/donator/delphic_synth
	...
	squeak_override = list('sound/emotes/emotes/dwoop.ogg' = 1)
	attack_verb_continuous = list(
		"lobotomizes",
		"appendectomys",
		"transplants",
...
/obj/item/toy/plush/nova/donator/chunko/bonnie
	...
	squeak_override = list(
		...
		'sound/emotes/voice/mothsqueak.ogg' = 1,
		)
	responses = list(
