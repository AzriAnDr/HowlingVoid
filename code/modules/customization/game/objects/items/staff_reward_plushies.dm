...
/obj/item/toy/plush/nova/melon
	...
	icon = 'icons/obj/staff_plushies.dmi'
...
/obj/item/toy/plush/nova/parsec
	...
	squeak_override = list(
		'sound/emotes/voice/bork.ogg' = 2,
		'sound/emotes/voice/mrrp.ogg' = 1,
		'sound/emotes/voice/bark1.ogg' = 3,
		'sound/emotes/voice/growl.ogg' = 1,
		'sound/emotes/voice/awoo.ogg' = 1,
		'sound/emotes/emotes/blush.ogg' = 1,
...
/obj/item/toy/plush/nova/akinshi
	...
	squeak_override = list(
		'sound/emotes/voice/nya.ogg' = 1,
		'sound/emotes/voice/mggaow.ogg' = 1,
		'sound/emotes/voice/scream_cat.ogg' = 1,
		)
	var/responses = list(
		"Uh huh.",
		"Go back to training.",
