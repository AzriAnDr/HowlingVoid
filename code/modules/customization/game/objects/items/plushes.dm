...
/obj/item/toy/plush/nova/ian
	...
	squeak_override = list('sound/emotes/voice/bark2.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/nova/towa
	...
	attack_verb_continuous = list("cuddles", "meows", "hisses")
	attack_verb_simple = list("cuddle", "meow", "hiss")
	squeak_override = list('sound/kahraman_equipment/thumper_thump/punch_press_2.wav' = 1)
...
/obj/item/toy/plush/nova/fushi
	...
	squeak_override = list(
		'sound/emotes/voice/wurble.ogg' = 10, //10% chance to wurble
		'sound/emotes/voice/weh.ogg' = 90,
	)
	gender = MALE
