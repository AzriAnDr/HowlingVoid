...
/obj/item/tank/internals/nitrogen/belt
	...
	worn_icon = 'icons/mob/clothing/species/vox/belt.dmi'
	lefthand_file = 'icons/mob/inhands/equipment/tanks_lefthand_additions.dmi'
	righthand_file = 'icons/mob/inhands/equipment/tanks_righthand_additions.dmi'
