...
/datum/action/cooldown/hemophage
	...
	background_icon = 'icons/customization/modules/mob/living/carbon/human/species/hemophage/icons/actions_hemophage.dmi'
...
/datum/action/cooldown/hemophage/hemokinetic_regen
	...
	background_icon = 'icons/customization/modules/mob/living/carbon/human/species/hemophage/icons/actions_hemophage.dmi'
	background_icon_state = "bg_hemophage"
	button_icon = 'icons/customization/modules/mob/living/carbon/human/species/hemophage/icons/actions_hemophage.dmi'
