...
/datum/sprite_accessory/genital/penis/get_special_icon(mob/living/carbon/human/target_mob)
	...
	return 'icons/mob/sprite_accessory/genitals/taur_penis_onmob.dmi'
...
/datum/sprite_accessory/genital/butt
	icon = 'icons/mob/sprite_accessory/genitals/butt_onmob.dmi'
...
/datum/sprite_accessory/genital/belly
	icon = 'icons/mob/sprite_accessory/genitals/belly_onmob.dmi'
