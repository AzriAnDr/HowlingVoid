...
* You can find a color palette to work with in icons/mob/sprite_accessory/wings.dmi as 'colorpalette matrixcolors'
...
/datum/sprite_accessory/wings/moth/bluespace
	name = "Moth (Bluespace)"
	icon = 'icons/mob/human/species/moth/moth_wings_grayscale.dmi'
