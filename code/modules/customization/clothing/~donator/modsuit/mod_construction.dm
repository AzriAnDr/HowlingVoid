...
//									code\modules\customization\clothing\~donator\donator_items.dm
...
/obj/item/mod/skin_applier/paragon
	...
	var/list/variant_data = list(
		MOD_ICON_OVERRIDE = 'icons/donator/obj/clothing/modsuit.dmi',
		MOD_WORN_ICON_OVERRIDE = 'icons/donator/mob/clothing/modsuit.dmi',
