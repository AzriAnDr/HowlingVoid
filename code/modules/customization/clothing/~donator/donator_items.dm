...
/obj/item/cigbutt/khi
	icon = 'icons/obj/cigarettes_khi.dmi'
	icon_state = "khibutt"
	...
	switch(current_state)
		if(TURN_DIAL)
			user.visible_message(
				...
				vision_distance=2)
			playsound(user, 'sound/effects/bab1.ogg', 100, TRUE)
			sparks.start()
		...
		if(TAP_SCREEN)
			user.visible_message(
				...
				vision_distance=2)
			playsound(user, 'sound/effects/platform_call.ogg', 100, TRUE)
		...
		if(PRESS_KEYS)
			user.visible_message(
				...
				vision_distance=2)
			sparks.start()
			playsound(user, 'sound/effects/gmalfunction.ogg', 100, TRUE)
		...
		if(SLAP_SIDE)
			user.visible_message(
				...
				vision_distance=2)
			playsound(user, 'sound/effects/hacked.ogg', 100, TRUE)
			sparks.start()
...
/obj/item/nanite_leg_reinforcement
	...
	icon = 'icons/modular_implants/obj/nifs.dmi'
	icon_state = "base_nif"
...
/obj/item/clothing/glasses/hud/ar/projector/science/sqn
	...
	worn_icon = 'icons/mob/clothing/under/misc_additions.dmi'
...
/obj/item/instrument/piano_synth/headphones/catear_headphone
	...
	worn_icon = 'icons/GAGS/head/catear_headphone.dmi'
	lefthand_file = 'icons/GAGS/head/catear_headphone_inhand.dmi'
	righthand_file = 'icons/GAGS/head/catear_headphone_inhand.dmi'
...
/obj/item/instrument/piano_synth/headphones/catear_headphone/worn_overlays(mutable_appearance/standing, isinhands, icon_file)
	. = ..()
	if(!isinhands)
		. += emissive_appearance('icons/GAGS/head/catear_headphone.dmi', "catearphones_[song?.playing ? "on" : "off"]_emissive", src, alpha = src.alpha)
		if(catTailToggled)
			. += emissive_appearance('icons/GAGS/head/catear_headphone.dmi', "catearphones_tail_on_emissive", src, alpha = src.alpha)
...
/obj/item/instrument/piano_synth/headphones/catear_headphone/update_overlays()
	. = ..()
	. += emissive_appearance('icons/GAGS/head/catear_headphone.dmi', "catearphones_obj_lights_emissive", src, alpha = src.alpha)
...
/obj/item/storage/backpack/merctac_backpack
	...
	icon = 'icons/donator/obj/clothing/back.dmi'
	worn_icon = 'icons/donator/mob/clothing/back.dmi'
...
/obj/item/gun/ballistic/automatic/miecz/ak105
	...
	icon = 'icons/donator/obj/guns48x.dmi'
	icon_state = "ak105sbr"
	worn_icon = 'icons/donator/mob/worn/weapons.dmi'
