...
/obj/item/clothing/under/costume/playbunny
	icon = 'icons/obj/clothing/under/bunnysuits.dmi'
	worn_icon = 'icons/mob/clothing/under/bunnysuits.dmi'
	worn_icon_digi = 'icons/mob/clothing/under/bunnysuits_digi.dmi'
