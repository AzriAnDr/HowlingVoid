#define MODULAR_SHOES_ICON 'icons/obj/clothing/shoes_additions.dmi'
#define MODULAR_SHOES_WORN_ICON 'icons/mob/clothing/feet_additions.dmi'
...
/obj/item/clothing/shoes/colorable_laceups
	...
	worn_icon = 'icons/GAGS/shoes/shoes.dmi'
	worn_icon_teshari = 'icons/GAGS/shoes/shoes_teshari.dmi'
