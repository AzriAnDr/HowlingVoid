...
/obj/machinery/door/manual_airlock
	...
	icon = 'icons/obj/doors/train/manual_airlock.dmi'
...
/obj/machinery/door/manual_airlock/proc/start_turning(mob/user, opening = TRUE)
	...
	playsound(src, 'sound/event/zvents/gatedoor_valve.ogg', 50, TRUE)  // Custom sound
...
/obj/machinery/door/manual_airlock/proc/stop_turning(mob/user)
	...
	playsound(src, 'sound/event/zvents/gatedoor_valve.ogg', 50, TRUE)
...
/obj/machinery/door/manual_airlock/open(forced = FALSE)
	...
	playsound(src, 'sound/event/zvents/gatedoor_open.ogg', 50, TRUE)
	return ..()


/obj/machinery/door/manual_airlock/close(forced = DEFAULT_DOOR_CHECKS, force_crush = FALSE)
	auto_turning = FALSE
	playsound(src, 'sound/event/zvents/gatedoor_close.ogg', 50, TRUE)
	return ..()
...
/obj/machinery/hypothermia/heater
	...
	icon = 'icons/colony_fabricator/thermomachine.dmi'
