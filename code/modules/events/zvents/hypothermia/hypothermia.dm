#define HYPOTHERMIA_TITLE_SCREEN 'icons/event/zvents/lobby/hypothermia.png'
...
/datum/full_round_event/hypothermia/new_player_spawned(client/player_client, mob/living/player_mob)
	INVOKE_ASYNC(src, PROC_REF(hypothermia_setup), player_mob)
