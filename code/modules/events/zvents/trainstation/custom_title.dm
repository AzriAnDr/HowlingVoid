...
/datum/asset/simple/lobby
	assets = list(
		...
		"OCRAExtended.ttf" = 'html/event/zvents/OCRAEXT.TTF',
	)
...
/datum/controller/subsystem/train_controller/proc/set_lobby_screen()
	SStitle.change_title_screen('icons/event/zvents/lobby/trainstation_v2.png')
	SSticker.set_lobby_music('sound/event/zvents/trainstation_lobbymusic.ogg', override = TRUE)
