...
/datum/train_station
	...
	/// Station flags are defined in code/__DEFINES/trainstation_event.dm.
...
/datum/train_station/gairen
	...
	ambience_sounds = list('sound/event/zvents/thefinalstation/piano_loop.ogg' = 33 SECONDS)
...
/datum/train_station/radiosphere
	...
	ambience_sounds = list('sound/event/zvents/radiosphere_loop1.ogg' = 40 SECONDS)
