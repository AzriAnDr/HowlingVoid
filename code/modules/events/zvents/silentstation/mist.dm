...
/datum/weather/fog/generate_overlay_cache()
	...
	for(var/offset in 0 to SSmapping.max_plane_offset)
		var/mutable_appearance/new_weather_overlay = mutable_appearance('icons/event/zvents/area/weather_overlays.dmi', weather_state, overlay_layer, plane = overlay_plane, offset_const = offset)
...
/atom/movable/screen/fullscreen/fog_effect
	icon = 'icons/event/zvents/fullscreen/fullscreen_fog.dmi'
	icon_state = "fog_full"
