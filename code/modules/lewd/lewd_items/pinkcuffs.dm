/obj/item/restraints/handcuffs/lewd
	...
	worn_icon = 'icons/lewd/icons/mob/lewd_items/lewd_items.dmi'
...
/obj/item/restraints/handcuffs/lewd/apply_cuffs(mob/living/carbon/target, mob/user, dispense = 0)
	. = ..()
	src.icon = 'icons/lewd/icons/obj/lewd_items/lewd_items.dmi'
	src.icon_state = "pinkcuffs"
	src.worn_icon = 'icons/lewd/icons/mob/lewd_items/lewd_items.dmi'
	src.worn_icon_state = "pinkcuffs"
	src.lefthand_file = 'icons/lewd/icons/mob/lewd_inhands/lewd_inhand_left.dmi'
	src.righthand_file = 'icons/lewd/icons/mob/lewd_inhands/lewd_inhand_right.dmi'

	// Similar code in general procedures does not correctly set the appearance
	target.remove_overlay(HANDCUFF_LAYER)
	if(!target.handcuffed)
		return
	target.overlays_standing[HANDCUFF_LAYER] = mutable_appearance('icons/lewd/icons/mob/lewd_items/lewd_items.dmi', "pinkcuffs", -HANDCUFF_LAYER)
