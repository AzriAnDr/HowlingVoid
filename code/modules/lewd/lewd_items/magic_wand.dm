...
/obj/item/clothing/sextoy/magic_wand/Initialize(mapload)
	...
	magicwand_overlay = mutable_appearance('icons/lewd/icons/mob/lewd_items/lewd_items.dmi', "magicwand", ABOVE_MOB_LAYER + 0.1) //two arguments
...
/obj/item/clothing/sextoy/magic_wand/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	playsound_if_pref(loc, 'sound/lewd/sounds/vibrate.ogg', (vibration_mode == "low" ? 10 : (vibration_mode == "high" ? 30 : 20)), TRUE, pref_to_check = /datum/preference/toggle/erp/sex_toy_sounds)
