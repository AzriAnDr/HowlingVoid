...
/obj/item/clockwork/weapon
	...
	desc = "Something"
	icon = 'icons/clock_cult/weapons/clockwork_weapons.dmi'
	lefthand_file = 'icons/clock_cult/weapons/clockwork_lefthand.dmi'
	righthand_file = 'icons/clock_cult/weapons/clockwork_righthand.dmi'
	worn_icon = 'icons/clock_cult/clockwork_garb_worn.dmi'
...
/obj/item/clockwork/weapon/attack(mob/living/target, mob/living/user)
	...
	if(!QDELETED(target) && target.stat != DEAD && !IS_CLOCK(target) && !target.can_block_magic(MAGIC_RESISTANCE_HOLY|MAGIC_RESISTANCE_SYNTHETIC_ALLOWED))
...
/obj/item/clockwork/weapon/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
	...
	if(!target.can_block_magic(MAGIC_RESISTANCE_HOLY|MAGIC_RESISTANCE_SYNTHETIC_ALLOWED) && !IS_CLOCK(target))
...
/obj/item/gun/ballistic/bow/clockwork/attack_self(mob/living/user)
	...
	drawn = TRUE
	playsound(src, 'sound/tribal_extended/sound_weapons_bowdraw.ogg', 75, 0) //gets way too high pitched if the freq varies
	update_icon()
...
/obj/item/gun/ballistic/rifle/lionhunter/clockwork
	...
	icon = 'icons/clock_cult/weapons/clockwork_weapons_40x32.dmi'
	lefthand_file = 'icons/clock_cult/weapons/clockwork_lefthand.dmi'
	righthand_file = 'icons/clock_cult/weapons/clockwork_righthand.dmi'
	worn_icon = 'icons/clock_cult/clockwork_garb_worn.dmi'
	slot_flags = ITEM_SLOT_BACK
