...
/obj/structure/destructible/clockwork/gear_base/powered/ocular_warden/process(seconds_per_tick)
	...
	playsound(src, 'sound/clock_cult/machinery/ocularwarden-target.ogg', 60, TRUE)
	...
	playsound(target, pick('sound/clock_cult/machinery/ocularwarden-dot1.ogg', 'sound/clock_cult/machinery/ocularwarden-dot2.ogg'), 60, TRUE)
