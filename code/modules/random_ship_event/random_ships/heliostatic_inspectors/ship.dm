...
/area/shuttle/hc_cops
	...
	ambient_buzz = 'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/amb_ship_01.ogg'
	ambient_buzz_vol = 15
	ambientsounds = list('sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/alarm_radio.ogg',
				'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/alarm_small_09.ogg',
				'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/gear_loop.ogg',
				'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/gear_start.ogg',
				'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/gear_stop.ogg',
				'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/intercom_loop.ogg')
...
/obj/docking_port/mobile/hc_ship
	...
	takeoff_sound = sound('sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/engine_ignit_int.ogg')
	landing_sound = sound('sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/env_ship_down.ogg')
...
/obj/machinery/porta_turret/syndicate/hc_police
	...
	icon = 'icons/random_ship_event/random_ships/heliostatic_inspectors/icons/turrets.dmi'
	icon_state = "gun_turret"
	base_icon_state = "gun_turret"
	max_integrity = 250
	stun_projectile = /obj/projectile/bullet/ciws
	lethal_projectile = /obj/projectile/bullet/ciws
	lethal_projectile_sound = 'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/shell_out_tiny.ogg'
	stun_projectile_sound = 'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/shell_out_tiny.ogg'
