...
/obj/item/clothing/sextoy/dildo/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	playsound_if_pref(loc, pick('sound/modular_items/lewd_items/sounds/bang1.ogg',
						'sound/modular_items/lewd_items/sounds/bang2.ogg',
						'sound/modular_items/lewd_items/sounds/bang3.ogg',
						'sound/modular_items/lewd_items/sounds/bang4.ogg',
						'sound/modular_items/lewd_items/sounds/bang5.ogg',
						'sound/modular_items/lewd_items/sounds/bang6.ogg'), 100, TRUE)
...
/obj/item/clothing/sextoy/dildo/double_dildo_end
	...
	icon = 'icons/modular_items/lewd_items/icons/obj/lewd_items/lewd_icons.dmi'
