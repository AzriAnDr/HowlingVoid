/obj/item/clothing/shoes/shibari_legs
	...
	worn_icon = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_shoes.dmi'
	worn_icon_digi = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_shoes_digi.dmi'
