/obj/item/clothing/suit/straight_jacket/kinky_sleepbag
	...
	worn_icon = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_normal.dmi'
	worn_icon_digi = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_digi.dmi'
	worn_icon_taur_snake = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_paw = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_hoof = 'icons/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/proc/fold(mob/user)
	bag_fold = !bag_fold
	playsound_if_pref(user, 'sound/modular_items/lewd_items/sounds/latex.ogg', 40, TRUE)
	if(bag_fold == TRUE)
		w_class = WEIGHT_CLASS_SMALL
		slot_flags = NONE
	if(bag_fold == FALSE)
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/process(seconds_per_tick)
	if(time_to_sound_left <= 0)
		if(tt <= 0)
			playsound_if_pref(loc, 'sound/modular_items/lewd_items/sounds/latex.ogg', 100, TRUE)
