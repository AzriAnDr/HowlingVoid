...
/obj/item/clothing/strapon/proc/update_mob_action_buttonss()
	for(var/datum/action/item_action/take_strapon/action_button in actions_types)
		...
		action_button.button_icon = 'icons/modular_items/lewd_items/icons/obj/lewd_items/lewd_items.dmi'
	update_appearance(UPDATE_ICON)
	...
	switch(user.zone_selected)
		if(BODY_ZONE_PRECISE_GROIN)
			...
			playsound_if_pref(loc, pick(
				...
				'sound/modular_items/lewd_items/sounds/bang6.ogg'), 60, TRUE)
		...
		if(BODY_ZONE_HEAD, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_PRECISE_EYES)
			...
			playsound_if_pref(loc, pick(
				...
				'sound/modular_items/lewd_items/sounds/bang4.ogg',
				'sound/modular_items/lewd_items/sounds/bang5.ogg',
				'sound/modular_items/lewd_items/sounds/bang6.ogg'), 40, TRUE)
