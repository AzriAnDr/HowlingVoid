/obj/structure/chair/shibari_stand
	...
	var/static/mutable_appearance/shibari_shadow_overlay = mutable_appearance('icons/modular_items/lewd_items/icons/obj/lewd_structures/shibari_stand.dmi', "shibari_shadow", LOW_OBJ_LAYER)
