...
/datum/emote/living/lewd/lewdmoan/get_sound(mob/living/carbon/user)
	...
	if(user.gender == MALE)
		return pick('sound/modular_items/lewd_items/sounds/final_m1.ogg',
					'sound/modular_items/lewd_items/sounds/final_m2.ogg',
					'sound/modular_items/lewd_items/sounds/final_m3.ogg',

		)
	else
		return pick('sound/modular_items/lewd_items/sounds/final_f1.ogg',
					'sound/modular_items/lewd_items/sounds/final_f2.ogg',
					'sound/modular_items/lewd_items/sounds/final_f3.ogg',
		)
