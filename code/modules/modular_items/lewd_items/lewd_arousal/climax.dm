...
/mob/living/carbon/human/proc/climax(manual = TRUE)
	...
	switch(gender)
		if(MALE)
			playsound_if_pref(get_turf(src), pick('sound/modular_items/lewd_items/sounds/final_m1.ogg',
										'sound/modular_items/lewd_items/sounds/final_m2.ogg',
										'sound/modular_items/lewd_items/sounds/final_m3.ogg'), 50, TRUE, pref_to_check = /datum/preference/toggle/erp/sounds)
		if(FEMALE)
			playsound_if_pref(get_turf(src), pick('sound/modular_items/lewd_items/sounds/final_f1.ogg',
										'sound/modular_items/lewd_items/sounds/final_f2.ogg',
										'sound/modular_items/lewd_items/sounds/final_f3.ogg'), 50, TRUE, pref_to_check = /datum/preference/toggle/erp/sounds)
