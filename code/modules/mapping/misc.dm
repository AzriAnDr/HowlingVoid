...
/obj/item/claymore/cutlass/luna
	...
	icon = 'icons/mapping/obj/weapons/sword.dmi'
	lefthand_file = 'icons/mapping/mob/inhands/weapons/swords_lefthand.dmi'
	righthand_file = 'icons/mapping/mob/inhands/weapons/swords_righthand.dmi'
	icon_state = "luna"
...
/obj/item/luna_fragment
	...
	icon = 'icons/mapping/obj/items/jungle_items.dmi'
