...
/obj/structure/statue/hearthkin/frozenwake
	...
	icon = 'icons/primitive_catgirls/gods_statue.dmi'
...
/obj/structure/statue/hearthkin/frozenwake/stele
	...
	icon = 'icons/primitive_catgirls/gods_statue.dmi' // needs its own sprite
...
/obj/structure/statue/hearthkin/frozenwake/stele/proc/add_runic_glow()
	return emissive_appearance(
		'icons/primitive_catgirls/gods_statue.dmi',
		"[icon_state]-emissive",
		src,
		alpha = src.alpha
	)
