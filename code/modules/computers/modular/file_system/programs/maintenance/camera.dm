...
// BEGIN NOVA CORE MIGRATION: code/modules/computers/modular/file_system/programs/maintenance/camera.dm
// Makes camera app readily available to crew
/datum/computer_file/program/maintenance/camera
	program_flags = PROGRAM_ON_NTNET_STORE
// END NOVA CORE MIGRATION: code/modules/computers/modular/file_system/programs/maintenance/camera.dm
