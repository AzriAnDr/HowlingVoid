	...
	switch(mode)
		...
		if("medical")
			for(var/datum/record/crew/person in GLOB.manifest.general)
				...
				current_record["age"] = person.age // NOVA EDIT ADDITION - Chronological age
				current_record["chrono_age"] = person.chrono_age // NOVA EDIT ADDITION - Chronological age
...
// BEGIN NOVA CORE MIGRATION: code/modules/computers/modular/file_system/programs/records.dm
/datum/computer_file/program/records/medical/New()
	LAZYOR(download_access, ACCESS_ROBOTICS)
	return ..()
// END NOVA CORE MIGRATION: code/modules/computers/modular/file_system/programs/records.dm
