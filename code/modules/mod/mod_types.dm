...
// BEGIN NOVA CORE MIGRATION: code/modules/mod/mod_types.dm
...
/obj/item/mod/control/pre_equipped/blueshield
	worn_icon = 'icons/mob/clothing/modsuit/mod_clothing_additions.dmi'
	icon = 'icons/obj/clothing/modsuit/mod_clothing_additions.dmi'
...
// END NOVA CORE MIGRATION: code/modules/mod/mod_types.dm
