...
// BEGIN NOVA CORE MIGRATION: code/modules/mod/mod_theme.dm
/datum/mod_theme/loader
	slot_flags = ITEM_SLOT_BELT
...
// icons/mob/clothing/modsuit/mod_clothing_mutant.dmi
/datum/mod_theme/syndicate/deepspace
	...
	variants = list(
		"deepspace" = list(
			MOD_ICON_OVERRIDE = 'icons/obj/clothing/modsuit/mod_clothing_additions.dmi',
			MOD_WORN_ICON_OVERRIDE = 'icons/mob/clothing/modsuit/mod_clothing_additions.dmi',
			/obj/item/clothing/head/mod = list(
				UNSEALED_LAYER = NECK_LAYER,
				UNSEALED_CLOTHING = SNUG_FIT,
				SEALED_CLOTHING = THICKMATERIAL|STOPSPRESSUREDAMAGE|HEADINTERNALS,
...
/datum/mod_theme/marines
	...
	variants = list(
		"marine" = list(
			MOD_ICON_OVERRIDE = 'icons/obj/clothing/modsuit/mod_clothing_additions.dmi',
			MOD_WORN_ICON_OVERRIDE = 'icons/mob/clothing/modsuit/mod_clothing_additions.dmi',
			MOD_DIGITIGRADE_ICON_OVERRIDE = 'icons/mob/clothing/modsuit/mod_clothing_mutant.dmi',
			MOD_SNOUT_ICON_OVERRIDE = 'icons/mob/clothing/modsuit/mod_clothing_mutant.dmi',
			/obj/item/clothing/head/mod = list(
				UNSEALED_LAYER = NECK_LAYER,
				UNSEALED_CLOTHING = SNUG_FIT,
...
// END NOVA CORE MIGRATION: code/modules/mod/mod_theme.dm
