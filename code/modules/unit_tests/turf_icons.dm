...
/datum/unit_test/maptest_turf_icons
	var/modular_mineral_turf_file = 'icons/xenoarch/mining.dmi' // NOVA EDIT CHANGE - ORIGINAL: var/modular_mineral_turf_file //= 'icons/turf/mining.dmi' //MODULARITY SUPPORT - insert your snowflake MAP_SWITCH icon file here if you use that define.
