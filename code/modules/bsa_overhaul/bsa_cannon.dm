...
/obj/machinery/bsa/full/proc/pre_fire(mob/user, turf/bullseye)
	...
	alert_sound_to_playing('sound/bsa_overhaul/superlaser_prefire.ogg', override_volume = TRUE)
...
/obj/machinery/bsa/full/proc/fire(mob/user, turf/bullseye)
	...
	if(!blocker)
		...
		alert_sound_to_playing('sound/bsa_overhaul/superlaser_firing.ogg', override_volume = TRUE)
		capacitor_power = 0
	else
