...
/obj/item/bodypart/head/mutant_zombie
	icon_greyscale = 'icons/mutants/mutant_parts_greyscale.dmi'
	icon = 'icons/mutants/mutant_parts_greyscale.dmi'
	icon_static = 'icons/mutants/mutant_parts_greyscale.dmi'
	icon_state = "mutant_head"
	is_dimorphic = FALSE
	limb_id = SPECIES_MUTANT
	species_color = "#ffffff"
	head_flags = HEAD_HAIR|HEAD_LIPS|HEAD_DEBRAIN
	eyes_icon = 'icons/mutants/mutant_eyes.dmi'
