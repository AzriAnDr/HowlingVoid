/obj/item/paper/paperslip/ration_ticket
	...
	icon = 'icons/paycheck_rations/tickets.dmi'
...
/obj/item/paper/paperslip/ration_ticket/proc/try_to_make_ration_order_list(obj/machinery/computer/cargo/object_we_attack, mob/living/user)
	...
	var/list/radial_meat_options = list(
		"Standard Meats" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "meats"),
		"Seafood Meats" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "meats_fish"),
		"Tizirian Meats" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "meats_lizard"),
	)
	...
	var/list/radial_produce_options = list(
		"Standard Produce" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "plants"),
		"Alternative Produce" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "plants_alt"),
		"Mothic Produce" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "plants_moth"),
		"Tizirian Produce" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "plants_lizard"),
	)
	...
	var/list/radial_flour_options = list(
		"Standard Flour" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "flour"),
		"Korta Flour" = image(icon = 'icons/paycheck_rations/food_containers.dmi', icon_state = "flour_korta"),
	)
...
/obj/item/paper/paperslip/ration_ticket/luxury/try_to_make_ration_order_list(obj/machinery/computer/cargo/object_we_attack, mob/living/user)
	...
	var/list/radial_alcohol_options = list(
		"Navy Rum" = image(icon = 'icons/obj/drinks.dmi', icon_state = "navy_rum"),
		"Ginger Beer" = image(icon = 'icons/obj/drinks.dmi', icon_state = "gingie_beer"),
		"Kortara" = image(icon = 'icons/obj/drinks.dmi', icon_state = "kortara"),
	)
