...
/obj/structure/mob_spawner
	...
	icon = 'icons/decay_subsystem/nests.dmi'
	icon_state = "nest"
	density = FALSE
	anchored = TRUE
	layer = TABLE_LAYER
...
/obj/structure/mob_spawner/proc/spawn_mob()
	var/sound/sound_to_play = pick('sound/effects/rustle1.ogg', 'sound/effects/rustle2.ogg')
...
/obj/item/spider_egg
	...
	icon = 'icons/decay_subsystem/loot.dmi'
