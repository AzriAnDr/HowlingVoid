/datum/artifact_effect/noise
	...
	var/static/list/possible_noises = list(
		...
		'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/alarm_radio.ogg',
		'sound/random_ship_event/random_ships/heliostatic_inspectors/sounds/morse.ogg', // I can spend all day here, adding sounds. But i wont.
	)
