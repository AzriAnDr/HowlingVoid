...
// BEGIN NOVA CORE MIGRATION: code/modules/research/designs/weapon_designs.dm
...
/datum/design/shotgun_dart_pen
	...
	departmental_flags = DEPARTMENT_BITFLAG_SECURITY
	autolathe_exportable = FALSE
// END NOVA CORE MIGRATION: code/modules/research/designs/weapon_designs.dm
