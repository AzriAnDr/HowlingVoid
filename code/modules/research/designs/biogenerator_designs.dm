...
// BEGIN NOVA CORE MIGRATION: code/modules/research/designs/biogenerator_designs.dm
...
/datum/design/kobold_cube
	...
	category = list(RND_CATEGORY_INITIAL, RND_CATEGORY_BIO_FOOD)
// END NOVA CORE MIGRATION: code/modules/research/designs/biogenerator_designs.dm
