...
// BEGIN NOVA CORE MIGRATION: code/modules/research/designs/limbgrower_designs.dm
...
// END NOVA CORE MIGRATION: code/modules/research/designs/limbgrower_designs.dm
