...
/turf/closed/mineral/strange_rock
	mineralAmt = 1
	icon = MAP_SWITCH('icons/liquids/turf/smoothrocks.dmi', 'icons/xenoarch/mining.dmi')
	icon_state = "rock_strange"
	scan_icon = 'icons/xenoarch/ore_visuals.dmi'
...
/turf/closed/mineral/strange_rock/ice
	icon = MAP_SWITCH('icons/turf/walls/icerock_wall.dmi', 'icons/xenoarch/mining.dmi')
...
/turf/closed/mineral/gibtonite/asteroid
	icon = MAP_SWITCH('icons/turf/walls/red_wall.dmi', 'icons/xenoarch/mining.dmi')
