...
/datum/scream_type/human
	...
	female_screamsounds = list(
		'sound/emotes/voice/scream_f1.ogg',
		'sound/emotes/voice/scream_f2.ogg',
		'sound/emotes/voice/scream_f3.ogg',
	)
...
/datum/scream_type/robotic
	name = "Robotic Scream"
	male_screamsounds = list('sound/emotes/voice/scream_silicon.ogg')
	female_screamsounds = null
...
/datum/scream_type/lizard2
	...
	male_screamsounds = list('sound/emotes/voice/scream_lizard.ogg')
	female_screamsounds = null

/datum/scream_type/cat
	name = "Cat Scream"
	male_screamsounds = list('sound/emotes/voice/scream_cat.ogg')
	female_screamsounds = null
...
/datum/scream_type/jelly
	name = "Jelly Scream"
	male_screamsounds = list('sound/emotes/emotes/jelly_scream.ogg')
	female_screamsounds = null

/datum/scream_type/vox
	name = "Vox Scream"
	male_screamsounds = list('sound/emotes/emotes/voxscream.ogg')
	female_screamsounds = null
...
/datum/scream_type/raptor //This is the Teshari scream ported from CitRP which was a cockatoo scream edited by BlackMajor.
	name = "Raptor Scream"
	male_screamsounds = list('sound/emotes/emotes/raptorscream.ogg')
	female_screamsounds = null

/datum/scream_type/rodent //Ported from Polaris/Virgo.
	name = "Rodent Scream"
	male_screamsounds = list('sound/emotes/emotes/rodentscream.ogg')
	female_screamsounds = null
...
/datum/scream_type/slugcat
	name = "Slugcat Scream"
	male_screamsounds = list('sound/emotes/voice/scugscream_1.ogg')
	female_screamsounds = null

//DONATOR SCREAMS
/datum/scream_type/zombie
	name = "Zombie Scream"
	male_screamsounds = list('sound/emotes/emotes/zombie_scream.ogg')
	female_screamsounds = null

/datum/scream_type/monkey
	name = "Monkey Scream"
	male_screamsounds = list('sound/emotes/voice/scream_monkey.ogg')
	female_screamsounds = null
...
/datum/scream_type/skeleton
	...
	male_screamsounds = list('sound/emotes/voice/scream_skeleton.ogg')
	female_screamsounds = null
