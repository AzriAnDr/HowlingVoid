...
/datum/emote/living/blush
	sound = 'sound/emotes/emotes/blush.ogg'
...
/datum/emote/living/quill
	...
	vary = TRUE
	sound = 'sound/emotes/emotes/voxrustle.ogg'
...
/datum/emote/living/peep
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/peep_once.ogg'
...
/datum/emote/living/peep2
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/peep.ogg'
...
/datum/emote/living/snap2
	...
	vary = TRUE
	sound = 'sound/emotes/voice/snap2.ogg'
...
/datum/emote/living/snap3
	...
	hands_use_check = TRUE
	vary = TRUE
	sound = 'sound/emotes/voice/snap3.ogg'
...
/datum/emote/living/awoo
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/awoo.ogg'
...
/datum/emote/living/nya
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/nya.ogg'
...
/datum/emote/living/weh
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/weh.ogg'
...
/datum/emote/living/yip
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/fox_squeak.ogg'
...
/datum/emote/living/gecker
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/gecker.ogg'
...
/datum/emote/living/alligrowl
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/alli_growl.ogg'
...
/datum/emote/living/allihiss
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/alli_hiss.ogg'
...
/datum/emote/living/allicall
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/alli_call.ogg'
...
/datum/emote/living/fwhine/get_sound(mob/living/user)
	return pick('sound/emotes/voice/fox1.ogg',
				'sound/emotes/voice/fox2.ogg',
				'sound/emotes/voice/fox3.ogg',
				'sound/emotes/voice/fox4.ogg',
				'sound/emotes/voice/fox5.ogg',
				'sound/emotes/voice/fox6.ogg',
				'sound/emotes/voice/fox7.ogg',
				'sound/emotes/voice/fox8.ogg',
				'sound/emotes/voice/fox9.ogg',
				'sound/emotes/voice/fox10.ogg',
				'sound/emotes/voice/fox11.ogg',
				'sound/emotes/voice/fox12.ogg',
				'sound/emotes/voice/fox13.ogg')
...
/datum/emote/living/merp
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/merp.ogg'
...
/datum/emote/living/bark
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/bark2.ogg'
...
/datum/emote/living/squish
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'sound/emotes/voice/slime_squish.ogg'
...
/datum/emote/living/bubble
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'sound/emotes/voice/slime_bubble.ogg'
...
/datum/emote/living/pop
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/slime_pop.ogg'
...
/datum/emote/living/hiss/get_sound(mob/living/user)
	if(isxenohybrid(user))
		...
		return 'sound/emotes/emotes/hiss.ogg'
...
/datum/emote/living/sigh/get_sound(mob/living/user)
	if(iscarbon(user))
		if(user.gender == MALE)
			return 'sound/emotes/emotes/male/male_sigh.ogg'
		return 'sound/emotes/emotes/female/female_sigh.ogg'
	return
...
/datum/emote/living/snore
	vary = TRUE
	sound = 'sound/emotes/emotes/snore.ogg'
...
/datum/emote/living/burp/get_sound(mob/living/user)
	if(iscarbon(user))
		if(user.gender == MALE)
			return 'sound/emotes/emotes/male/burp_m.ogg'
		return 'sound/emotes/emotes/female/burp_f.ogg'
	return
...
/datum/emote/living/clap1/get_sound(mob/living/user)
	return pick('sound/emotes/emotes/claponce1.ogg',
				'sound/emotes/emotes/claponce2.ogg')
...
/datum/emote/beep
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/emotes/twobeep.ogg'
...
/datum/emote/living/bawk
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/bawk.ogg'
...
/datum/emote/living/caw
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/caw.ogg'
...
/datum/emote/living/caw2
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/caw2.ogg'
...
/datum/emote/living/bork
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/bork.ogg'
...
/datum/emote/living/hoot
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/hoot.ogg'
...
/datum/emote/living/growl
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'sound/emotes/voice/growl.ogg'
	specific_emote_audio_cooldown = 4 SECONDS
...
/datum/emote/living/woof
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/woof.ogg'
...
/datum/emote/living/baa
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/baa.ogg'
...
/datum/emote/living/baa2
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/baa2.ogg'
...
/datum/emote/living/wurble
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/wurble.ogg'
	specific_emote_audio_cooldown = 4 SECONDS
...
/datum/emote/living/rattle
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'sound/emotes/voice/rattle.ogg'
...
/datum/emote/living/cackle
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/cackle_yeen.ogg'
	specific_emote_audio_cooldown = 5 SECONDS
...
/datum/emote/living/warble
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/warbles.ogg'
...
/datum/emote/living/trills
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/trills.ogg'
...
/datum/emote/living/rpurr
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'sound/emotes/voice/raptor_purr.ogg'
...
/datum/emote/living/moo
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/moo.ogg'
...
/datum/emote/living/honk
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/goose_honk.ogg'
...
/datum/emote/living/mggaow
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/mggaow.ogg'
...
/datum/emote/living/mrrp
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/mrrp.ogg'
...
/datum/emote/living/prbt
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/prbt.ogg'
...
/datum/emote/living/sigh_exasperated/get_sound(mob/living/user)
	if(iscarbon(user))
		if(user.gender == MALE)
			return 'sound/emotes/emotes/male/male_sigh_exasperated.ogg'
		return 'sound/emotes/emotes/female/female_sigh_exasperated.ogg'
	return
...
/datum/emote/living/awuff
	...
	sound = 'sound/emotes/voice/awuff.ogg'
	emote_type = EMOTE_AUDIBLE
	vary = TRUE

/datum/emote/living/awuff/get_sound(mob/living/user)
	. = ..()
	return pick('sound/emotes/voice/awuff.ogg', 'sound/emotes/voice/awuff2.ogg', 'sound/emotes/voice/awuff3.ogg')
...
/datum/emote/living/arf
	...
	sound = 'sound/emotes/voice/arf.ogg'
	emote_type = EMOTE_AUDIBLE
	vary = TRUE

/datum/emote/living/arf/get_sound(mob/living/user)
	. = ..()
	return pick('sound/emotes/voice/arf.ogg', 'sound/emotes/voice/arf2.ogg', 'sound/emotes/voice/arf3.ogg')
...
/datum/emote/living/coyhowl
	...
	sound = 'sound/emotes/voice/coyotehowl.ogg'
...
/datum/emote/living/coyhowl/get_sound(mob/living/user)
	. = ..()
	return pick(
		'sound/emotes/voice/coyotehowl.ogg',
		'sound/emotes/voice/coyotehowl2.ogg',
		'sound/emotes/voice/coyotehowl3.ogg',
		'sound/emotes/voice/coyotehowl4.ogg',
		'sound/emotes/voice/coyotehowl5.ogg',
	)
...
/datum/emote/living/wolfhowl
	...
	sound = 'sound/emotes/voice/wolfhowl.ogg'
...
/datum/emote/living/wolfhowl/get_sound(mob/living/user)
	. = ..()
	return pick('sound/emotes/voice/wolfhowl.ogg', 'sound/emotes/voice/wolfhowl2.ogg', 'sound/emotes/voice/wolfhowl3.ogg')
...
/datum/emote/living/dwhine
	...
	sound = 'sound/emotes/voice/dwhine.ogg'
...
/datum/emote/living/dwhine/get_sound(mob/living/user)
	. = ..()
	return pick(
		'sound/emotes/voice/dwhine.ogg',
		'sound/emotes/voice/dwhine2.ogg',
		'sound/emotes/voice/dwhine3.ogg',
		'sound/emotes/voice/dwhine4.ogg',
		'sound/emotes/voice/dwhine5.ogg',
	)
...
/datum/emote/living/dgrowl
	...
	sound = 'sound/emotes/voice/dgrowl.ogg'
...
/datum/emote/living/dgrowl/get_sound(mob/living/user)
	. = ..()
	return pick(
		'sound/emotes/voice/dgrowl.ogg',
		'sound/emotes/voice/dgrowl2.ogg',
		'sound/emotes/voice/dgrowl3.ogg',
		'sound/emotes/voice/dgrowl4.ogg',
		'sound/emotes/voice/dgrowl5.ogg',
	)
...
/datum/emote/living/aggrobark
	...
	sound = 'sound/emotes/voice/aggrobark.ogg'
...
/datum/emote/living/aggrobark/get_sound(mob/living/user)
	. = ..()
	return pick('sound/emotes/voice/aggrobark.ogg', 'sound/emotes/voice/aggrobark2.ogg', 'sound/emotes/voice/aggrobark3.ogg', 'sound/emotes/voice/aggrobark4.ogg')
...
/datum/emote/living/dcomplain
	...
	sound = 'sound/emotes/voice/dcomplain.ogg'
...
/datum/emote/living/dcomplain/get_sound(mob/living/user)
	. = ..()
	return pick(
		'sound/emotes/voice/dcomplain.ogg',
		'sound/emotes/voice/dcomplain2.ogg',
		'sound/emotes/voice/dcomplain3.ogg',
		'sound/emotes/voice/dcomplain4.ogg',
		'sound/emotes/voice/dcomplain5.ogg',
	)
...
/datum/emote/living/meowdeep
	...
	sound = 'sound/emotes/voice/meowdeep.ogg'
	emote_type = EMOTE_AUDIBLE
	vary = TRUE

/datum/emote/living/meowdeep/get_sound(mob/living/user)
	. = ..()
	return pick('sound/emotes/voice/meowdeep.ogg', 'sound/emotes/voice/meowdeep2.ogg', 'sound/emotes/voice/meowdeep3.ogg')
...
/datum/emote/living/teshchirp
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/teshchirp.ogg' // Credits to Virgo Station for the files.
...
/datum/emote/living/teshsqueak
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/teshsqueak.ogg' // Credits to Virgo Station for the files.
...
/datum/emote/living/teshtrill
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'sound/emotes/voice/teshtrill.ogg' // Credits to Virgo Station for the files.
...
/datum/emote/living/gulp/get_sound(mob/living/user)
	return pick(
		'sound/emotes/voice/gulp1.ogg',
		'sound/emotes/voice/gulp2.ogg',
	)

/datum/emote/living/carbon/wink
	sound = 'sound/emotes/voice/wink.ogg'

/datum/emote/living/carbon/human/blink
	sound = 'sound/emotes/voice/blink.ogg'
...
/datum/emote/living/mar
	...
	vary = TRUE
	sound = 'sound/emotes/voice/mar.ogg'
