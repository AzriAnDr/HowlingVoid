...
/obj/machinery/power/colony_ore_thumper
	...
	icon = 'icons/kahraman_equipment/ore_thumper.dmi'
	...
	var/static/list/list_of_thumper_sounds = list(
		'sound/kahraman_equipment/thumper_thump/punch_press_1.wav',
		'sound/kahraman_equipment/thumper_thump/punch_press_2.wav',
	)
...
/obj/machinery/power/colony_ore_thumper/proc/make_some_ore()
	...
	for(var/iteration in 1 to rand(2, 4))
		...
		playsound(new_ore_pile, 'sound/effects/robot_sit.ogg', 25, TRUE)
...
/obj/item/flatpacked_machine/ore_thumper
	...
	icon = 'icons/kahraman_equipment/ore_thumper_item.dmi'
