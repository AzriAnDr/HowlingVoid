...
// BEGIN NOVA CORE MIGRATION: code/modules/reagents/reagent_containers/hypospray.dm
/obj/item/reagent_containers/hypospray/medipen
...
/obj/item/reagent_containers/hypospray/medipen/universal
	...
	icon = 'icons/lathe_medipens/syringe.dmi'
	lefthand_file = 'icons/lathe_medipens/medical_lefthand.dmi'
	righthand_file = 'icons/lathe_medipens/medical_righthand.dmi'
...
/// Returns overlays for reagents inside the medipen.
/obj/item/reagent_containers/hypospray/medipen/universal/proc/update_reagent_overlay()
	if(!reagents?.total_volume)
		return

	var/mutable_appearance/filling_overlay = mutable_appearance('icons/lathe_medipens/reagent_fillings.dmi', "medipen")
...
/obj/item/reagent_containers/hypospray/medipen/universal/lowpressure/update_reagent_overlay()
	...
	var/mutable_appearance/filling_overlay = mutable_appearance('icons/lathe_medipens/reagent_fillings.dmi', overlay_icon)
	filling_overlay.color = mix_color_from_reagents(reagents.reagent_list)
	. += filling_overlay
...
/obj/item/reagent_containers/hypospray/medipen/universal/lowpressure/inject(mob/living/affected_mob, mob/user)
	...
	if(. && !used_up)
		update_appearance()
// END NOVA CORE MIGRATION: code/modules/reagents/reagent_containers/hypospray.dm
