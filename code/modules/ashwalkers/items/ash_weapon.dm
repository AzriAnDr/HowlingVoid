...
/obj/item/melee/macahuitl
	...
	icon = 'icons/ashwalkers/ashwalker_clothing.dmi'
	lefthand_file = 'icons/ashwalkers/ashwalker_clothing_left.dmi'
	righthand_file = 'icons/ashwalkers/ashwalker_clothing_right.dmi'
