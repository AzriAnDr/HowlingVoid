...
/obj/item/organ/cyberimp/brain/nif
	...
	var/good_sound ='sound/modular_implants/default_good.ogg'
	///This is the sound that plays if there is an issue going on.
	var/bad_sound = 'sound/modular_implants/default_bad.ogg'
	///This is the sound that you would hear if you enable if you activate or enable something.
	var/click_sound = 'sound/modular_implants/default_click.ogg'
	///What icon does the NIF display in chat when sending out alerts? Icon states are stored in 'icons/modular_implants/chat.dmi'
...
/datum/asset/spritesheet_batched/chat/create_spritesheets()
	...
	insert_all_icons("nif", 'icons/modular_implants/chat.dmi')
