...
/datum/action/innate/constrict
	...
	button_icon = 'icons/taur_mechanics/ability.dmi'
...
/obj/structure/serpentine_tail
	...
	icon = 'icons/taur_mechanics/tail.dmi'
	icon_state = "naga"
	pixel_x = -16
...
/obj/structure/serpentine_tail/proc/add_tail_overlay()
	...
	tail_overlay = mutable_appearance('icons/taur_mechanics/tail.dmi', "naga_top", ABOVE_MOB_LAYER + 0.01, src)
...
/atom/movable/screen/alert/status_effect/constricted
	...
	icon = 'icons/taur_mechanics/ability.dmi'
