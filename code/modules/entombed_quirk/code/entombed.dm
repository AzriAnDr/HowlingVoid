...
/datum/quirk/equipping/entombed/add_unique(client/client_source)
	...
	switch(LOWER_TEXT(modsuit.skin))
		if ("colonist", "tarkon", "voskhod")
			modsuit.icon = 'icons/obj/clothing/modsuit/mod_clothing_additions.dmi'
			modsuit.worn_icon = 'icons/mob/clothing/modsuit/mod_clothing_additions.dmi'
	...
	for(var/obj/item/part as anything in modsuit.get_parts())
		...
		switch(LOWER_TEXT(modsuit.skin))
			if ("colonist", "tarkon", "voskhod")
				part.icon = 'icons/obj/clothing/modsuit/mod_clothing_additions.dmi'
				part.worn_icon = 'icons/mob/clothing/modsuit/mod_clothing_additions.dmi'
