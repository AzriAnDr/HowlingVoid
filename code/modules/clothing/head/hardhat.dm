...
// BEGIN NOVA CORE MIGRATION: code/modules/clothing/head/hardhat.dm
/obj/item/clothing/head/utility/hardhat/welding
...
/obj/item/clothing/head/utility/hardhat/welding/adjust_visor(mob/living/user)
	...
	if(carbon_user.dna.mutant_bodyparts[FEATURE_SNOUT])
		visor_sprite_path = 'icons/mob/clothing/head_muzzled.dmi'
	else
...
// END NOVA CORE MIGRATION: code/modules/clothing/head/hardhat.dm
