#define SKIRTS_DRESSES_DIGIFILE 'icons/mob/clothing/under/skirts_dresses_digi.dmi'
...
/obj/item/clothing/under/dress/nova
	icon = 'icons/obj/clothing/under/skirts_dresses.dmi'
	worn_icon = 'icons/mob/clothing/under/skirts_dresses.dmi'
