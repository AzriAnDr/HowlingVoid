...
// BEGIN NOVA CORE MIGRATION: code/modules/clothing/under/color.dm
/obj/item/clothing/under/color/rainbow
	worn_icon_digi = 'icons/mob/clothing/under/color_digi.dmi'
...
// END NOVA CORE MIGRATION: code/modules/clothing/under/color.dm
