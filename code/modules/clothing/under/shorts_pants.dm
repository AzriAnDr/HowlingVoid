#define SHORTS_PANTS_SHIRTS_DIGIFILE 'icons/mob/clothing/under/shorts_pants_shirts_digi.dmi'
...
/obj/item/clothing/under/pants/nova
	icon = 'icons/obj/clothing/under/shorts_pants_shirts_additions.dmi'
