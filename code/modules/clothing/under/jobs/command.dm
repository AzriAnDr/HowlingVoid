...
// BEGIN NOVA CORE MIGRATION: code/modules/clothing/under/jobs/command.dm
/obj/item/clothing/under/rank/captain
	worn_icon_digi = 'icons/mob/clothing/under/command_digi.dmi'
...
/obj/item/clothing/under/rank/captain/nova/pilot/skirt
	...
	supports_variations_flags = CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON
	gets_cropped_on_taurs = FALSE
// END NOVA CORE MIGRATION: code/modules/clothing/under/jobs/command.dm
