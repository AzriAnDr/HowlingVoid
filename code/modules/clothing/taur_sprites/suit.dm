/obj/item/clothing/suit/space/eva
	worn_icon_taur_snake = 'icons/mob/clothing/suit_taur_snake.dmi'
	worn_icon_taur_paw = 'icons/mob/clothing/suit_taur_paw.dmi'
...
/obj/item/clothing/suit/hooded/explorer
	worn_icon_taur_snake = 'icons/mob/clothing/suit_taur_snake.dmi'
	worn_icon_taur_paw = 'icons/mob/clothing/suit_taur_paw.dmi' // very good sprite, but slightly outdated
	flags_inv = HIDETAUR
...
/obj/item/clothing/suit/utility/bomb_suit // strangely, this isnt based off the carbon sprite, but is way better
	worn_icon_taur_snake = 'icons/mob/clothing/suit_taur_snake.dmi'
	worn_icon_taur_paw = 'icons/mob/clothing/suit_taur_paw.dmi'
	worn_icon_taur_hoof = 'icons/mob/clothing/suit_taur_hoof.dmi'
