...
// BEGIN NOVA CORE MIGRATION: code/modules/clothing/glasses/_glasses.dm
...
/obj/item/clothing/glasses/blindfold/color
	name = "blind personnel blindfold"
	desc = "Indicates that the wearer suffers from blindness."
	worn_icon = 'icons/GAGS/eyes_worn.dmi'
...
// END NOVA CORE MIGRATION: code/modules/clothing/glasses/_glasses.dm
