...
#define TOWEL_WORN_ICON_DIGI 'icons/mob/clothing/towel_digi.dmi'
/// Icon path to the left-hand inhand icons of the towel.
#define TOWEL_LEFTHAND_ICON 'icons/mob/inhands/clothing/towel_lefthand.dmi'
/// Icon path to the right-hand inhand icons of the towel.
#define TOWEL_RIGHTHAND_ICON 'icons/mob/inhands/clothing/towel_righthand.dmi'
