...
/obj/item/clothing/shoes/get_blood_overlay(blood_state, mutant_styles)
	...
	if(clothing_flags & LARGE_WORN_ICON)
		blood_overlay = mutable_appearance('icons/digi_bloodsole/64x64.dmi', "shoeblood_large_digi")
	else
		blood_overlay = mutable_appearance('icons/digi_bloodsole/blood.dmi', "shoeblood_digi")
