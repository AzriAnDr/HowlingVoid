...
// BEGIN NOVA CORE MIGRATION: code/modules/clothing/clothing.dm
...
/proc/generate_taur_clothing(index, icon/icon_to_process, icon_state)
	...
	var/icon/taur_cropping_mask = icon("icon" = 'icons/mob/clothing/taur_masking_helpers.dmi', "icon_state" = taur_icon_state)
...
/proc/wear_taur_version(icon_state, icon/icon_to_process, female_type, greyscale_colors)
	...
	return taur_clothing_icon
// END NOVA CORE MIGRATION: code/modules/clothing/clothing.dm
