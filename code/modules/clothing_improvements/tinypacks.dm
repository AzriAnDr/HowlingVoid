/obj/item/storage/backpack/tinypakb
	...
	icon = 'icons/clothing_improvements/clothing.dmi'
	worn_icon = 'icons/clothing_improvements/clothing_worn.dmi'
	worn_icon_teshari = 'icons/mob/clothing/species/teshari/back.dmi'
