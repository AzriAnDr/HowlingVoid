...
/obj/item/robot_model/clown
	borg_skins = list(
		...
		"Bootyborg" = list(SKIN_ICON_STATE = "bootyclown", SKIN_ICON = 'icons/borgs/robots_clown.dmi'),
		"Male Bootyborg" = list(SKIN_ICON_STATE = "male_bootyclown", SKIN_ICON = 'icons/borgs/robots_clown.dmi'),
		"ARACHNE" = list(SKIN_ICON_STATE = "arachne_clown", SKIN_ICON = 'icons/borgs/robots_clown.dmi'),
		"Slipper" = list(SKIN_ICON_STATE = "slipper_clown", SKIN_ICON = 'icons/borgs/robots_clown.dmi'),
		"Marina" = list(SKIN_ICON_STATE = "marina_mommy", SKIN_ICON = 'icons/borgs/robots_clown.dmi', SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK)),
		"Garish" = list(SKIN_ICON_STATE = "garish", SKIN_ICON = 'icons/borgs/robots_clown.dmi'),
		"Robot" = list(SKIN_ICON_STATE = "clownbot", SKIN_ICON = 'icons/borgs/robots_clown.dmi'),
		"Sleek" = list(SKIN_ICON_STATE = "clownman", SKIN_ICON = 'icons/borgs/robots_clown.dmi', SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK)),
		/// 32x64 skins
...
/obj/item/robot_model/cargo
	...
	model_select_alternate_icon = 'icons/borgs/screen_cyborg.dmi'
	canDispose = TRUE
	borg_skins = list(
		/// 32x32 Skins
