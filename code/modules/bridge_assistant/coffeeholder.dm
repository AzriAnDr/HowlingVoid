/obj/item/storage/box/coffee_tray
	...
	icon = 'icons/bridge_assistant/coffeeholder.dmi'
	icon_state = "holder"
	inhand_icon_state = "cawfeeinhand"
	lefthand_file = 'icons/bridge_assistant/coffeeholder_lefthand.dmi'
	righthand_file = 'icons/bridge_assistant/coffeeholder_righthand.dmi'
