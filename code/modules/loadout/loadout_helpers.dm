...
/mob/living/carbon/human/proc/equip_outfit_and_loadout(
	...
	var/list/loadout_datums = loadout_list_to_datums(item_details[preference_source.read_preference(/datum/preference/loadout_index)]) // NOVA EDIT CHANGE - Multiple loadout presets - ORIGINAL: var/list/loadout_datums = loadout_list_to_datums(item_details)
...
// BEGIN NOVA CORE MIGRATION: code/modules/loadout/loadout_helpers.dm
...
/proc/get_active_loadout_list(datum/preferences/preference_source) as /list
	...
	return list()
// END NOVA CORE MIGRATION: code/modules/loadout/loadout_helpers.dm
