/obj/item/storage/toolbox/emergency/turret/mag_fed/cerberus
	...
	icon = 'icons/tarkon/obj/turret.dmi'
	icon_state = "cerberus_toolbox"
	righthand_file = 'icons/tarkon/mob/inhands/righthand.dmi'
	lefthand_file = 'icons/tarkon/mob/inhands/lefthand.dmi'
	inhand_icon_state = "cerberus_turretkit"
	worn_icon_state = "cerberus_harness"
	worn_icon = 'icons/tarkon/mob/clothing/belt.dmi'
	has_latches = FALSE
