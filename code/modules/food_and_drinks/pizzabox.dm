...
/obj/item/pizzavoucher
	...
	icon = 'icons/pizza_voucher/pizza_voucher.dmi'
	icon_state = "pizza_voucher"
	w_class = WEIGHT_CLASS_SMALL
	/// Whether the voucher was already used.
	var/spent = FALSE
	/// Whether the voucher announces its delivery loudly.
...
/obj/item/pizzavoucher/attack_self(mob/user)
	...
	desc += " This one seems to be used-up."
	spent = TRUE
	user.visible_message(
		span_notice("A small bluespace rift opens just above [user]'s head and spits out a pizza box!"),
