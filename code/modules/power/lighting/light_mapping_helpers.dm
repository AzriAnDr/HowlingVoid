...
// BEGIN NOVA CORE MIGRATION: code/modules/power/lighting/light_mapping_helpers.dm
...
/obj/machinery/light/floor
	...
	nightshift_light_color = null
	nightshift_brightness = 4
// END NOVA CORE MIGRATION: code/modules/power/lighting/light_mapping_helpers.dm
