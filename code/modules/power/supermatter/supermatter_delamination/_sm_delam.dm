...
/datum/sm_delam/proc/delam_progress(obj/machinery/power/supermatter_crystal/sm)
	...
	switch(sm.get_status())
		if(SUPERMATTER_DELAMINATING)
			// NOVA EDIT ADDITION
			alert_sound_to_playing('sound/effects/reactor/meltdown.ogg', override_volume = TRUE)
		...
		if(SUPERMATTER_EMERGENCY)
			// NOVA EDIT ADDITION
			alert_sound_to_playing('sound/effects/reactor/core_overheating.ogg', override_volume = TRUE)
