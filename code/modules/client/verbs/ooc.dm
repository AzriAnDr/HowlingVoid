...
/client/verb/ooc(msg as text)
	...
	if(SSplayer_ranks.is_donator(src))
		if(prefs.read_preference(/datum/preference/toggle/display_donator_status))
			keyname = "<font color='[prefs.read_preference(/datum/preference/color/ooc_color) || GLOB.normal_ooc_colour]'>[icon2html('icons/donator/donator_chat_icon.dmi', world, "howling_void_logo")][keyname]</font>"
