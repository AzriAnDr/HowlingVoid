...
/datum/preference/choiced/footstep_sound/apply_to_human(mob/living/carbon/human/target, value)
	...
	var/static/list/value_to_define = list(
		...
		"Highheels" = list(list(
			'sound/effects/footstep/highheel1.ogg',
			'sound/effects/footstep/highheel2.ogg',
			'sound/effects/footstep/highheel3.ogg',
			'sound/effects/footstep/highheel4.ogg'), 70, 1),
		"Hooves" = list(list(
			'sound/effects/footstep/hardhoof1.ogg',
			'sound/effects/footstep/hardhoof2.ogg',
			'sound/effects/footstep/hardhoof3.ogg',
			'sound/effects/footstep/hardhoof4.ogg'), 35, 1),
	)
