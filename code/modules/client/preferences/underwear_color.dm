...
// BEGIN NOVA CORE MIGRATION: code/modules/client/preferences/underwear_color.dm
...
/datum/preference/color/bra_color/is_accessible(datum/preferences/preferences)
	...
	var/datum/species/species = GLOB.species_prototypes[species_type]
	return !(TRAIT_NO_UNDERWEAR in species.inherent_traits)
// END NOVA CORE MIGRATION: code/modules/client/preferences/underwear_color.dm
