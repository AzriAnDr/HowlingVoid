...
// BEGIN NOVA CORE MIGRATION: code/modules/surgery/organs/internal/heart/heart_anomalock.dm
/obj/item/organ/heart/cybernetic/anomalock
...
/datum/status_effect/voltaic_overdrive/short
	emp_resist = FALSE
	duration = 10 SECONDS
// END NOVA CORE MIGRATION: code/modules/surgery/organs/internal/heart/heart_anomalock.dm
