...
// BEGIN NOVA CORE MIGRATION: code/modules/surgery/organs/internal/lungs/_lungs.dm
/obj/item/organ/lungs/
...
// END NOVA CORE MIGRATION: code/modules/surgery/organs/internal/lungs/_lungs.dm
