...
// BEGIN NOVA CORE MIGRATION: code/modules/surgery/operations/operation_organ_repair.dm
/datum/surgery_operation/organ/repair
...
/datum/surgery_operation/organ/repair/brain/mechanic
	blocked_organ_flag = ORGAN_SYNTHETIC_FROM_SPECIES
// END NOVA CORE MIGRATION: code/modules/surgery/operations/operation_organ_repair.dm
