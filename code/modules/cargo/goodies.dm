...
// BEGIN NOVA CORE MIGRATION: code/modules/cargo/goodies.dm

// Disabled Stuff so we dont have to mantain two different sets of stuffs
...
/datum/supply_pack/goody/double_barrel
	console_flag = CARGO_CONSOLE_NO
	discountable = SUPPLY_PACK_NOT_DISCOUNTABLE
// END NOVA CORE MIGRATION: code/modules/cargo/goodies.dm
