...
/datum/supply_pack/companies
	...
	private_crate_type = /obj/structure/closet/crate/secure/owned
	crate_name = "company import crate"
	auto_name = TRUE
	order_flags = ORDER_COMPANY
	discountable = SUPPLY_PACK_RARE_DISCOUNTABLE
	ships_in_goody_case = TRUE

// Original logic, gives 5% of the stuff people buy to cargo and leaves the gun check for pins
/datum/supply_pack/companies/generate(atom/A, datum/bank_account/paying_account, crate_override, private_label_account = TRUE)
