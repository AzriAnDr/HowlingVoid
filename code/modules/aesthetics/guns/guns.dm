...
/obj/item/gun/ballistic/shotgun/automatic/combat
	...
	icon = 'icons/aesthetics/guns/icons/guns.dmi'
	worn_icon = 'icons/aesthetics/guns/icons/guns_back.dmi'
	lefthand_file = 'icons/aesthetics/guns/icons/guns_lefthand.dmi'
	righthand_file = 'icons/aesthetics/guns/icons/guns_righthand.dmi'
...
/obj/item/ammo_casing/energy
	fire_sound = 'sound/aesthetics/guns/sound/laser.ogg'

/obj/item/ammo_casing/energy/laser/pulse
	fire_sound = 'sound/aesthetics/guns/sound/pulse.ogg'

/obj/item/gun/energy/laser/xray
	fire_sound_volume = 100

/obj/item/ammo_casing/energy/xray
	fire_sound = 'sound/aesthetics/guns/sound/xray_laser.ogg'

/obj/item/ammo_casing/energy/laser/accelerator
	fire_sound = 'sound/aesthetics/guns/sound/laser_cannon_fire.ogg'

/obj/item/gun/ballistic/automatic/sniper_rifle
	name = "sniper rifle"
	desc = "A long ranged weapon that does significant damage. No, you can't quickscope."
	icon = 'icons/aesthetics/guns/icons/guns_gubman2.dmi'
	icon_state = "sniper"
...
/obj/item/gun/ballistic/automatic/sniper_rifle/modular
	...
	icon_state = "sniper"
	worn_icon_state = "sniper"
	fire_sound = 'sound/aesthetics/guns/sound/sniperrifle.ogg'
	suppressed_sound = 'sound/aesthetics/guns/sound/sniperrifle_s.ogg'
	w_class = WEIGHT_CLASS_BULKY
	can_suppress = FALSE
