/obj/structure/window/fulltile
	icon = 'icons/aesthetics/windows/icons/window.dmi'
...
/obj/structure/window/reinforced/fulltile
	icon = 'icons/aesthetics/windows/icons/r_window.dmi'
	canSmoothWith = SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_WALLS
...
/obj/structure/window/reinforced/tinted/fulltile
	icon = 'icons/aesthetics/windows/icons/r_window_tinted.dmi'
...
/obj/structure/window/plasma/fulltile
	icon = 'icons/aesthetics/windows/icons/window_plasma.dmi'
	icon_state = "window-0"
...
/obj/structure/window/reinforced/plasma/fulltile
	icon = 'icons/aesthetics/windows/icons/r_window_plasma.dmi'
	icon_state = "reinforced_window-0"
	base_icon_state = "reinforced_window"
	canSmoothWith = SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_WALLS
