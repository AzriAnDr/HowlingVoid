...
/turf/closed/wall/r_wall
	icon = 'icons/aesthetics/walls/icons/reinforced_wall.dmi'
...
/turf/closed/wall/material
	icon = 'icons/aesthetics/walls/icons/material_wall.dmi'
	icon_state = "wall-0"
	base_icon_state = "wall"
...
/obj/structure/falsewall
	icon = 'icons/aesthetics/walls/icons/wall.dmi'
	fake_icon = 'icons/aesthetics/walls/icons/wall.dmi'

/obj/structure/falsewall/reinforced
	name = "reinforced wall"
	desc = "A huge chunk of reinforced metal used to separate rooms."
	icon = 'icons/aesthetics/walls/icons/reinforced_wall.dmi'
	fake_icon = 'icons/aesthetics/walls/icons/reinforced_wall.dmi'

/obj/structure/falsewall/material
	icon = 'icons/aesthetics/walls/icons/material_wall.dmi'
	icon_state = "wall-open"
	base_icon_state = "wall"
	fake_icon = 'icons/aesthetics/walls/icons/material_wall.dmi'
