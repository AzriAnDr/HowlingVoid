...
/datum/action/cooldown/spell/pointed/projectile/web_restraints
	...
	button_icon = 'icons/spider/spider.dmi'
...
/datum/action/cooldown/spell/pointed/projectile/webhook
	...
	button_icon = 'icons/spider/abilities.dmi'
...
/obj/projectile/hook/web
	name = "webhook"
	icon_state = "webhook"
	icon = 'icons/spider/abilities.dmi'
	chain_icon = 'icons/spider/abilities.dmi'
