/obj/item/gun/ballistic/shotgun/katyusha/shitzu // Pulls from katyusha Shotgun
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/syndicate_armaments/ballistic48x.dmi'
	worn_icon = 'icons/modular_weapons/mob/company_and_or_faction_based/nanotrasen_armories/guns_worn.dmi'
	lefthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/syndicate_armaments/guns_lefthand.dmi'
	righthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/syndicate_armaments/guns_righthand.dmi'
