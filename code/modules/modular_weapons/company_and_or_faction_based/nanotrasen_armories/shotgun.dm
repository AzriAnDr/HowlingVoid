/obj/item/gun/ballistic/shotgun/katyusha
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/nanotrasen_armories/ballistic48x.dmi'
	icon_state = "spikewall"

	worn_icon = 'icons/modular_weapons/mob/company_and_or_faction_based/nanotrasen_armories/guns_worn.dmi'
	worn_icon_state = "spikewall"

	lefthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/nanotrasen_armories/guns_lefthand.dmi'
	righthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/nanotrasen_armories/guns_righthand.dmi'
	...
	fire_sound = 'sound/weapons/shotgun_nova.ogg' // Meatier shotgun sound
