...
/obj/item/gun/ballistic/automatic/sol_rifle
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/carwo_defense_systems/guns48x.dmi'
	...
	lefthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/carwo_defense_systems/guns_lefthand.dmi'
	righthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/carwo_defense_systems/guns_righthand.dmi'
