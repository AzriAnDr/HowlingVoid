...
/obj/item/gun/ballistic/pump_launcher
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/scarborough_arms/launchers48x.dmi'
	icon_state = "boarder40"
	worn_icon = 'icons/modular_weapons/mob/company_and_or_faction_based/scarborough_arms/guns_worn.dmi'
