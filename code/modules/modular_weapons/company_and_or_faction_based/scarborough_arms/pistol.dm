/obj/item/gun/ballistic/automatic/pistol/enforcer
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/scarborough_arms/pistol.dmi'
	icon_state = "magnum"
	lefthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/scarborough_arms/guns_lefthand.dmi'
	righthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/scarborough_arms/guns_righthand.dmi'
	...
	fire_sound = 'sound/modular_weapons/bay_gunshot_magnum.ogg'
	load_sound = 'sound/modular_weapons/bay_magnum_in.ogg'
	load_empty_sound = 'sound/modular_weapons/bay_magnum_in.ogg'
	eject_sound = 'sound/modular_weapons/bay_magnum_out.ogg'
	eject_empty_sound = 'sound/modular_weapons/bay_magnum_out.ogg'
