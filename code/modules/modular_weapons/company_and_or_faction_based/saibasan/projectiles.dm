...
/obj/item/ammo_casing/energy/cybersun_big_kill
	...
	select_name = "Kill"
	fire_sound = 'sound/modular_weapons/laser_firing/laser.ogg'

/obj/projectile/beam/cybersun_laser
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/saibasan/projectiles.dmi'
...
/obj/item/ammo_casing/energy/cybersun_big_sniper
	...
	fire_sound = 'sound/modular_weapons/laser_firing/vaporize.ogg'
...
/obj/projectile/beam/cybersun_laser/granata/proc/fuse_activation(atom/target)
	...
	playsound(src, 'sound/modular_weapons/grenade_burst.ogg', 50, TRUE, -3)
	qdel(shrapnel_maker)
...
/obj/item/ammo_casing/energy/cybersun_big_shotgun
	...
	variance = 30
	select_name = "Shotgun"
	fire_sound = 'sound/modular_weapons/laser_firing/melt.ogg'
