...
/obj/item/gun/energy/modular_laser_rifle
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/saibasan/guns48x.dmi'
	icon_state = "hyeseong_kill"
	lefthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/saibasan/guns_lefthand.dmi'
	righthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/saibasan/guns_righthand.dmi'
	inhand_icon_state = "hyeseong_kill"
	worn_icon = 'icons/modular_weapons/mob/company_and_or_faction_based/saibasan/guns_worn.dmi'
...
/obj/item/gun/energy/modular_laser_rifle/carbine
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/saibasan/guns32x.dmi'
