...
/obj/item/gun/ballistic/automatic/sol_classic
	...
	icon = 'icons/modular_weapons/obj/company_and_or_faction_based/veldjen-kuiper_armories/guns48x.dmi'
	icon_state = "infanterie"

	worn_icon = 'icons/modular_weapons/mob/company_and_or_faction_based/veldjen-kuiper_armories/guns_worn.dmi'
	worn_icon_state = "infanterie"

	lefthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/veldjen-kuiper_armories/guns_lefthand.dmi'
	righthand_file = 'icons/modular_weapons/mob/company_and_or_faction_based/veldjen-kuiper_armories/guns_righthand.dmi'
	...
	suppressed_sound = 'sound/modular_weapons/suppressed_rifle.ogg'
	can_suppress = TRUE
