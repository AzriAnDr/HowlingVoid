...
/datum/action/cooldown/spell/conjure_item/psionic/psitool
	...
	button_icon = 'code/modules/psionics/icons/psi_items.dmi'
...
/obj/item/psionic_omnitool
	...
	icon = 'code/modules/psionics/icons/psi_items.dmi'
...
/obj/item/psionic_omnitool/Initialize(mapload)
	. = ..()
	tool_list = list(
			"Crowbar" = image(icon = 'code/modules/psionics/icons/psi_items.dmi', icon_state = "crowbar"),
			"Screwdriver" = image(icon = 'code/modules/psionics/icons/psi_items.dmi', icon_state = "screwdriver"),
			"Wirecutters" = image(icon = 'code/modules/psionics/icons/psi_items.dmi', icon_state = "cutters"),
			"Wrench" = image(icon = 'code/modules/psionics/icons/psi_items.dmi', icon_state = "wrench"),
		)
