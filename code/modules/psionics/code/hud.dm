...
/atom/movable/screen/psionic
	icon = 'code/modules/psionics/icons/psi_hud.dmi'
...
/datum/psionic/proc/update_hud()
	...
	energy?.maptext = FORMAT_PSI_HUD_TEXT(psi_energy_color, mana_level)
	energy?.icon_state = psi_energy_icon_state
	...
	signal?.icon_state = psi_signal_icon_state
