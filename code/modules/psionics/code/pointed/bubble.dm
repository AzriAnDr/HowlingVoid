/datum/action/cooldown/spell/pointed/psionic/bubble
	name = "Psionic Bubble"
	desc = "Create a protective bubble around you or target that removes your need to breathe or wear space protection! Slows down a little."
...
/datum/action/cooldown/spell/pointed/psionic/bubble/cast(atom/cast_on)
	...
	playsound(cast_on, 'code/modules/psionics/sounds/power_used.ogg', 50, TRUE)
	return TRUE
...
/datum/status_effect/psi_bubble/on_apply()
	...
	owner.add_movespeed_modifier(/datum/movespeed_modifier/bubble)
...
/datum/status_effect/psi_bubble/on_remove()
	...
	owner.remove_movespeed_modifier(/datum/movespeed_modifier/bubble)
...
/atom/movable/screen/alert/status_effect/psi_bubble
	...
	overlay_state = "bubbles"

/datum/movespeed_modifier/bubble
	multiplicative_slowdown = 0.1
	movetypes = FLYING|GROUND|FLOATING
