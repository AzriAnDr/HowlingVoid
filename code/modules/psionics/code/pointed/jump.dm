...
/datum/action/cooldown/spell/pointed/psionic/jump/cast(atom/cast_on)
	. = ..()
	do_teleport(owner, get_turf(cast_on), 1, /obj/effect/temp_visual/dir_setting/ninja, /obj/effect/temp_visual/dir_setting/ninja, 'code/modules/psionics/sounds/power_fabrication.ogg', channel = TELEPORT_CHANNEL_MAGIC)
	drain_mana()
	return TRUE
