...
/datum/looping_sound/core_heartbeat
	...
	mid_sounds = list('sound/effects/heart_beat_loop3.ogg' = 1)
	volume = 20
...
/obj/structure/mold/resin
	...
	icon = 'icons/mold/blob_resin.dmi'
...
/obj/structure/mold/structure/conditioner
	...
	density = FALSE
	icon = 'icons/mold/blob_spawner.dmi'
