...
/obj/machinery/status_display/shuttle/process()
	...
	return display_shuttle_status(SSshuttle.getShuttle(shuttle_id, FALSE))
...
// BEGIN NOVA CORE MIGRATION: code/game/machinery/status_display.dm
#define NOVA_ALERTS_ICON_FILE 'icons/obj/machines/status_display_additions.dmi'
...
// END NOVA CORE MIGRATION: code/game/machinery/status_display.dm
