...
/// Called on an object when a tool with billow capabilities is used to left click an object
/atom/proc/billow_act(mob/living/user, obj/item/tool)
	return

/// Called on an object when a tool with billow capabilities is used to right click an object
/atom/proc/billow_act_secondary(mob/living/user, obj/item/tool)
	return

/// Called on an object when a tool with tong capabilities is used to left click an object
/atom/proc/tong_act(mob/living/user, obj/item/tool)
	return

/// Called on an object when a tool with tong capabilities is used to right click an object
...
/// Called on an object when a tool with hammer capabilities is used to right click an object
/atom/proc/hammer_act_secondary(mob/living/user, obj/item/tool)
	return

/// Called on an object when a tool with blowrod capabilities is used to left click an object
/atom/proc/blowrod_act(mob/living/user, obj/item/tool)
	return

/// Called on an object when a tool with blowrod capabilities is used to right click an object
