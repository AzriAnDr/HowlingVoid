...
/obj/item/clothing/head/helmet/chaplain/bland
	icon = 'icons/obj/clothing/head/chaplain_additions.dmi'
	worn_icon = 'icons/mob/clothing/head/chaplain_additions.dmi'
...
/obj/item/clothing/suit/chaplainsuit/armor/templar/generic
	icon = 'icons/obj/clothing/suits/chaplain_additions.dmi'
	worn_icon = 'icons/mob/clothing/suits/chaplain_additions.dmi'
...
/obj/item/nullrod/rosary
	...
	icon = 'icons/chaplain/holy_weapons.dmi'
	icon_state = "rosary"
