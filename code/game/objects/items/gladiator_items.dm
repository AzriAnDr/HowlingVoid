...
/obj/item/clothing/neck/warrior_cape
	...
	icon = 'icons/gladiator/berserk_icons.dmi'
	worn_icon = 'icons/gladiator/berserk_suit.dmi'
...
/obj/item/clothing/suit/hooded/berserker/gatsu
	...
	icon = 'icons/gladiator/berserk_icons.dmi'
	worn_icon = 'icons/gladiator/berserk_suit.dmi'
	worn_icon_digi = 'icons/gladiator/berserk_suit_digi.dmi'
...
/obj/item/claymore/dragonslayer
	...
	icon = 'icons/gladiator/dragonslayer.dmi'
	icon_state = "dragonslayer"
	inhand_icon_state = "dragonslayer"
	lefthand_file = 'icons/mob/64x64_lefthand.dmi'
	righthand_file = 'icons/mob/64x64_righthand.dmi'
...
/obj/item/claymore/dragonslayer/very_fucking_loud
	...
	desc = null
	hitsound = 'sound/gladiator/Clang_cut.ogg'
