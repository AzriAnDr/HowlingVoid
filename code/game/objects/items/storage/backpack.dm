...
// BEGIN NOVA CORE MIGRATION: code/game/objects/items/storage/backpack.dm
#define NOVA_BACKPACK_ICON_DEFINES \
	icon = 'icons/obj/clothing/backpacks.dmi';\
	worn_icon = 'icons/mob/clothing/back_additions.dmi';\
	lefthand_file = 'icons/mob/inhands/clothing/backpack_lefthand.dmi';\
	righthand_file = 'icons/mob/inhands/clothing/backpack_righthand.dmi';\
...
/obj/item/storage/backpack/messenger/science/robo
	...
	NOVA_BACKPACK_ICON_DEFINES
// END NOVA CORE MIGRATION: code/game/objects/items/storage/backpack.dm
