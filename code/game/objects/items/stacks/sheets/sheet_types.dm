...
// BEGIN NOVA CORE MIGRATION: code/game/objects/items/stacks/sheets/sheet_types.dm
...
// END NOVA CORE MIGRATION: code/game/objects/items/stacks/sheets/sheet_types.dm
