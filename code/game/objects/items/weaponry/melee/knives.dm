...
/obj/item/knife/bowie
	...
	icon = 'icons/knives/bowie.dmi'
	icon_state = "bowiehand"
	inhand_icon_state = "bowiehand"
	lefthand_file = 'icons/knives/bowie_lefthand.dmi'
	righthand_file = 'icons/knives/bowie_righthand.dmi'
	worn_icon_state = "knife"
	force = 20
	w_class = WEIGHT_CLASS_NORMAL
	throwforce = 15
...
/obj/item/storage/belt/bowie_sheath
	...
	icon = 'icons/knives/bowiepocket.dmi'
