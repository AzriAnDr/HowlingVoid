/obj/item/melee/breaching_hammer
	...
	icon = 'icons/sec_haul/peacekeeper/peacekeeper_items.dmi'
	icon_state = "peacekeeper_hammer"
	inhand_icon_state = "peacekeeper_hammer"
	worn_icon_state = "classic_baton"
	lefthand_file = 'icons/sec_haul/peacekeeper/baton/peacekeeper_baton_lefthand.dmi'
	righthand_file = 'icons/sec_haul/peacekeeper/baton/peacekeeper_baton_righthand.dmi'
