...
// BEGIN NOVA CORE MIGRATION: code/game/objects/structures/plaques/static_plaques.dm
// NSV Blueshift: merged on Oct 1, 2021 (#8124 of Skyrat-SS13/Skyrat-tg)
...
// END NOVA CORE MIGRATION: code/game/objects/structures/plaques/static_plaques.dm
