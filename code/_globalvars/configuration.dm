...
// BEGIN NOVA CORE MIGRATION: code/_globalvars/configuration.dm
// LOOC Module
...
/// Are the TG gas prices being overridden? See code\modules\customization\__HELPERS\global_lists.dm to configure the prices.
/datum/config_entry/flag/override_gas_prices
// END NOVA CORE MIGRATION: code/_globalvars/configuration.dm
