...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_BURNING_BLOOD" = TRAIT_BURNING_BLOOD,
		...
		"TRAIT_HIDE_BACK_SLOT" = TRAIT_HIDE_BACK_SLOT,
		...
		"TRAIT_MOBILITY_ABILITIES_BLOCKED" = TRAIT_MOBILITY_ABILITIES_BLOCKED,
		...
		"TRAIT_NO_BONE_WOUNDS" = TRAIT_NO_BONE_WOUNDS,
		...
		"TRAIT_NO_ACCENT" = TRAIT_NO_ACCENT,
		...
		"TRAIT_REGENERATION" = TRAIT_REGENERATION,
		...
		"TRAIT_XENO_FORTIFY" = TRAIT_XENO_FORTIFY,
	...
	/obj/item/toy/plush/nova = list(
		...
		"TRAIT_SHARP_CLAWS" = TRAIT_SHARP_CLAWS,
