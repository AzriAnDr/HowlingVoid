...
/datum/keybinding/mob/swap_hands
	hotkey_keys = list("X") //HOWLING VOID EDIT. ORIGINAL: list("Unbound")
	name = "swap_hands"
...
/datum/keybinding/mob/select_hand/right
	hotkey_keys = list("Unbound") //HOWLING VOID EDIT. ORIGINAL: list("E")
...
/datum/keybinding/mob/select_hand/left
	hotkey_keys = list("Unbound") //HOWLING VOID EDIT. ORIGINAL: list("Q")
