...
/datum/quirk/oversized
	...
	lose_text = span_notice("Is it still the same size...?")
	...
	/// Saves refs to the original organs in nullspace in case this quirk gets removed.
...
/datum/quirk/oversized/add(client/client_source)
	...
	human_holder.dna.species.gain_oversized_organs(human_holder, src)
