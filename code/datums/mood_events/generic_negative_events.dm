...
// BEGIN NOVA CORE MIGRATION: code/datums/mood_events/generic_negative_events.dm
...
// END NOVA CORE MIGRATION: code/datums/mood_events/generic_negative_events.dm
