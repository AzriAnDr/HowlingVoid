...
/datum/storage/security_belt/handle_enter(datum/source, obj/item/arrived)
	...
	if(is_type_in_list(arrived, limited_hold_types) && (arrived.w_class > WEIGHT_CLASS_SMALL)) // weight class check for small guns/telebatons
		limited_held++
		if(isgun(arrived))
			playsound(parent, 'sound/sec_haul/holsterin.ogg', 50, rustle_vary, -5)
...
/obj/item/storage/belt/utility/chief/full/PopulateContents()
	SSwardrobe.provide_type(/obj/item/screwdriver/power/ce, src)
	SSwardrobe.provide_type(/obj/item/crowbar/power/ce, src)
	...
	SSwardrobe.provide_type(/obj/item/wrench/bolter/ce, src)

/obj/item/storage/belt/utility/chief/full/get_types_to_preload()
	var/list/to_preload = list()
	to_preload += /obj/item/screwdriver/power/ce
	to_preload += /obj/item/crowbar/power/ce
	to_preload += /obj/item/weldingtool/electric
	to_preload += /obj/item/multitool
	to_preload += /obj/item/stack/cable_coil
	to_preload += /obj/item/extinguisher/mini
	to_preload += /obj/item/analyzer/ranged
	to_preload += /obj/item/wrench/bolter/ce
	return to_preload
