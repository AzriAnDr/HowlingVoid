/// Icon file to start with when drawing holomaps.
#define HOLOMAP_ICON 'code/modules/holomaps/icons/480x480.dmi'
/// Pixel width and height of the holomap icon. Used for auto-centering.
...
#define HOLOMAP_SOFT_OBSTACLE "#ffffff54"
#define HOLOMAP_PATH "#66666699"
#define HOLOMAP_ROCK "#66666644"
#define HOLOMAP_HOLOFIER "#0096bb"
