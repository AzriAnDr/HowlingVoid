...
#define PENIS_ICON_ALT 'icons/mob/sprite_accessory/genitals/penis_onmob_alt.dmi'
#define TESTICLES_ICON_ALT 'icons/mob/sprite_accessory/genitals/testicles_onmob_alt.dmi'
#define BREASTS_ICON_ALT 'icons/mob/sprite_accessory/genitals/breasts_onmob_alt.dmi'
