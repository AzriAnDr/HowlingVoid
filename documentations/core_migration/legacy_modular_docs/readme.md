...
And then you'll want to establish your core folder that you'll be working out of which is normally your module ID. E.g. `former_nova_module_tree/modules/shuttle_toggle`
...
- **_Example:_** You're adding a new lavaland mob.
  ...
  First of all you create your modular folder. E.g. `former_nova_module_tree/modules/lavalandmob`
  ...
  ```byond
    /mob/lavaland/newmob
      icon = 'former_nova_module_tree/modules/lavalandmob/icons/mob.dmi'
      icon_state = "dead_1"
      sound = 'former_nova_module_tree/modules/lavalandmob/sounds/boom.ogg'
  ```
...
Example: `code/modules/mob/living/living.dm` -> `code/modules/mob/living/living.dm`
...
In short, most of the modular code will be placed in the subfolders of your main module folder **`former_nova_module_tree/modules/yourmodule/code/`**, with similar rules as with the assets. Do not mirror core code folder structures inside your modular folder.

For example, `former_nova_module_tree/modules/xenoarcheaology/code` containing all the code, tools, items and machinery related to it.
...
- **Removal:**
  ...
  *Please avoid this however, only to be done if there is no other option.
  ...
  ```byond
  /* // NOVA EDIT REMOVAL START - SHUTTLE_TOGGLE - (Moved to former_nova_module_tree/shuttle_toggle/randomverbs.dm)
...
- Good: /former_nova_module_tree/modules/example_module/code/disease_mob.dm
- Bad: /former_nova_module_tree/modules/example_module/code/modules/antagonists/disease/disease_mob.dm

**Icons**: Any .DMI files must go in here.

- Good: /former_nova_module_tree/modules/example_module/icons/mining_righthand.dmi
- Bad: /former_nova_module_tree/modules/example_module/icons/mob/inhands/equipment/mining_righthand.dmi
