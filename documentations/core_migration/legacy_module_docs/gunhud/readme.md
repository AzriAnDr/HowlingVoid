...
- `former_nova_module_tree\master_files\code\game\objects\items\tools\weldingtool.dm`: `proc/Initialize`, `proc/set_welding`
- `code\modules\projectiles\guns\ballistic.dm`: `proc/eject_magazine`, `proc/insert_magazine`
- `code\modules\projectiles\guns\energy.dm`: `proc/process`, `proc/select_fire`
