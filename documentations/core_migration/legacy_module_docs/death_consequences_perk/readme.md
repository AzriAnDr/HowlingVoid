...
E.g:
- `former_nova_module_tree/master_files/sound/my_cool_sound.ogg`
- `former_nova_module_tree/master_files/code/my_modular_override.dm`: `proc/overriden_proc`, `var/overriden_var`
  -->
...
- code\modules\client\preferences\quirks\death_consequences.dm
