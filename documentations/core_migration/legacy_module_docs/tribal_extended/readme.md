...
The recipes are added to "/datum/antagonist/primitive_catgirl" in "former_nova_module_tree*/modules_primitive_catgirls/code/spawner.dm" which is the code used to attribute hearthkin recipes
