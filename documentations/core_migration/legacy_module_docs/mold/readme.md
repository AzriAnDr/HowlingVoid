...
| --------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `former_nova_module_tree/modules/biohazard_blob/code/_biohazard_blob_defines.dm` | `BIO_MOLD_TYPE_FUNGUS`<br>`BIO_MOLD_TYPE_FIRE`<br>`BIO_MOLD_TYPE_EMP`<br>`BIO_MOLD_TYPE_TOXIC`<br>`ALL_BIO_BLOB_TYPES`<br>`FACTION_MOLD` |
