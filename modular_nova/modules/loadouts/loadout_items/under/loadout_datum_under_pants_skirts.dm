/*
*	CASUALWEAR
*	Intended for nonspecific uniforms: things that are recolorable and/or mix-and-match. Jeans, T-Shirts, Skirts.
*	Do not put items here that are too specific. These should generally be the most customizable uniforms for players.
*/
