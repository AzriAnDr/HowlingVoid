...
- `modular_nova/modules/corporate_economy/code/corporate_economy.dm`: subsystem vars, ledger procs, basket metrics, poverty metrics, export summaries, economic shock helpers, sensitive cargo order logging, and TGUI source breakdown helpers.
...
- `modular_nova/modules/imported_vendors/code/`: assigns explicit food and drink prices for imported vending products.
...
- `modular_nova/modules/company_imports/code/objects/cargo_console_and_case.dm`: allows restricted company imports and reports sensitive orders.
...
- `modular_nova/modules/corporate_economy/code/corporate_economy.dm`: переменные подсистемы, ledger procs, basket metrics, poverty metrics, export summaries, economic shock helpers, sensitive cargo logging и TGUI source breakdown helpers.
...
- `modular_nova/modules/company_imports/code/objects/cargo_console_and_case.dm`: разрешает restricted company imports и репортит sensitive orders.
