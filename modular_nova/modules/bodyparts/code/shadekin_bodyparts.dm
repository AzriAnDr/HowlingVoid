...
// SHADEKIN //
#define BODYPART_ICON_SHADEKIN 'modular_nova/modules/bodyparts/icons/shadekin_hv_parts_greyscale.dmi'
...
/obj/item/bodypart/head/shadekin
	...
	brute_modifier = 1.2
	burn_modifier = 1.2
	eyes_icon = 'modular_nova/modules/shadekin/icons/shadekin_hv_eyes.dmi'
